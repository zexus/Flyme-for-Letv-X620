.class final Lcom/mediatek/mom/CallInterceptionListenerTrigger;
.super Lcom/mediatek/mom/ListenerTriggerBase;
.source "CallInterceptionListenerTrigger.java"


# static fields
.field public static final TAG:Ljava/lang/String; = "CallInterceptionListenerTrigger"
...
.method public triggerListenerFunc()I
    ...
    .line 64
    invoke-virtual {p0}, Lcom/mediatek/mom/CallInterceptionListenerTrigger;->getParams()Landroid/os/Bundle;

    move-result-object v1

    .line 65
    invoke-virtual {p0}, Lcom/mediatek/mom/CallInterceptionListenerTrigger;->getFunc()Landroid/os/IBinder;

    move-result-object v2

    const-string/jumbo v3, "CallInterceptionListenerTrigger"
    ...
    const-string/jumbo v5, "[triggerListenerFunc]"
    ...
    const-string/jumbo v1, "CallInterceptionListenerTrigger"

    const-string/jumbo v2, "Ignore null listener"
    ...
    const-string/jumbo v3, "[MoMS << MoMA] onIncomingCallCheck() returned: "
    ...
    const-string/jumbo v2, "CallInterceptionListenerTrigger"

    const-string/jumbo v3, "onNotificationBlocked() failed!"
