...
.method constructor <init>(Lcom/android/server/am/ActivityManagerService;Landroid/os/Handler;Ljava/lang/String;JZ)V
    ...
    .line 173
    const-string/jumbo v1, "com.stv.stvpush"
...
.method private isSkipBroadcastSender(Ljava/lang/String;)Z
    ...
    const-string/jumbo v4, "isSkipBroadcastSender: packageName = "
    ...
    iget-object v1, p0, Lcom/android/server/am/BroadcastQueue;->mSkipBroadcastSenders:[Ljava/lang/String;
    ...
    .line 179
    iget-object v3, p0, Lcom/android/server/am/BroadcastQueue;->mSkipBroadcastSenders:[Ljava/lang/String;
    ...
    const-string/jumbo v7, "isSkipBroadcastSender: pkg = "
    ...
    const-string/jumbo v3, "isSkipBroadcastSender: "
    ...
    const-string/jumbo v3, "is a skip broadcast sender."
...
.method final processNextBroadcast(Z)V
    ...
    .line 761
    .local v51, "target":Ljava/lang/Object;
    sget-boolean v4, Lcom/android/server/am/ActivityManagerDebugConfig;->DEBUG_BROADCAST:Z
    ...
    .end local v51    # "target":Ljava/lang/Object;
    const/4 v4, 0x0
    ...
    .line 829
    .end local v42    # "numReceivers":I
    :cond_11
    const/16 v42, 0x0

    .restart local v42    # "numReceivers":I
    goto :goto_3
    ...
    .line 927
    .local v27, "filter":Lcom/android/server/am/BroadcastFilter;
    sget-boolean v4, Lcom/android/server/am/ActivityManagerDebugConfig;->DEBUG_BROADCAST:Z
    ...
    .end local v27    # "filter":Lcom/android/server/am/BroadcastFilter;
    ...
    .restart local v27    # "filter":Lcom/android/server/am/BroadcastFilter;
    ...
    aget-object v49, v4, v29
    :try_end_9
    .catchall {:try_start_9 .. :try_end_9} :catchall_0

    .line 1009
    .local v49, "requiredPermission":Ljava/lang/String;
    :try_start_a
    ...
    .line 1044
    .end local v29    # "i":I
    .end local v49    # "requiredPermission":Ljava/lang/String;
    :cond_27
    :goto_c
    if-nez v50, :cond_28
    ...
    .line 1014
    .end local v43    # "opCode":I
    .restart local v29    # "i":I
    .restart local v49    # "requiredPermission":Ljava/lang/String;
    :catch_1
    move-exception v21
    ...
    .end local v21    # "e":Landroid/os/RemoteException;
    :cond_31
    invoke-static/range {v49 .. v49}, Landroid/app/AppOpsManager;->permissionToOpCode(Ljava/lang/String;)I
    ...
    .line 1035
    invoke-static/range {v49 .. v49}, Landroid/app/AppOpsManager;->permissionToOp(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-interface {v4, v6}, Landroid/content/pm/IPackageManager;->isAppDouble(Ljava/lang/String;)Z
    ...
    const-string/jumbo v7, "xulei call after getCloneResolveInfo  r:"
    ...
    const-string/jumbo v7, ",r.intent:"
    ...
    const-string/jumbo v7, ", targetProcess:"
    ...
    iget v7, v7, Landroid/content/pm/ApplicationInfo;->uidOffset:I
    ...
    const-string/jumbo v7, "xulei call info.activityInfo is clone r:"
    ...
    const-string/jumbo v7, ", callerApp:"
    ...
    .line 1218
    .local v31, "infoPkg":Ljava/lang/String;
    move-object/from16 v0, v46
    ...
    .line 1222
    const-string/jumbo v7, ", r.callingUid = "
    ...
    .line 1223
    const-string/jumbo v7, ", r.callingPid = "
    ...
    .line 1224
    const-string/jumbo v7, ", r.callerApp = "
    ...
    .line 1225
    const-string/jumbo v7, ", r.callerPackage = "
    ...
    .end local v31    # "infoPkg":Ljava/lang/String;
    .end local v32    # "infoUid":I
    :cond_3d
    :goto_13
    if-eqz v37, :cond_3f
    ...
    .line 1236
    .restart local v5    # "targetProcess":Ljava/lang/String;
    .restart local v18    # "check":I
    .restart local v20    # "curUid":I
    .restart local v31    # "infoPkg":Ljava/lang/String;
    .restart local v32    # "infoUid":I
    :cond_3e
    const/16 v37, 0x1
