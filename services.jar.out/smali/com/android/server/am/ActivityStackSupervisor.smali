...
.method public constructor <init>(Lcom/android/server/am/ActivityManagerService;Lcom/android/server/am/RecentTasks;)V
    ...
    iput-object v0, p0, Lcom/android/server/am/ActivityStackSupervisor;->mPm:Landroid/content/pm/IPackageManager;
...
.method computeStackFocus(Lcom/android/server/am/ActivityRecord;Z)Lcom/android/server/am/ActivityStack;
    ...
    const-string/jumbo v7, "computeStackFocus: Setting focused stack to r="
    ...
    const-string/jumbo v7, "computeStackFocus: Focused stack already="
    ...
    const-string/jumbo v7, "computeStackFocus: Have a focused stack="
    ...
    const-string/jumbo v7, "computeStackFocus: Setting focused stack="
    ...
    const-string/jumbo v7, "computeStackFocus: New stack r="
...
.method moveHomeStack(ZLjava/lang/String;Lcom/android/server/am/ActivityStack;)V
    ...
    iget-object v2, v4, Lcom/android/server/am/ActivityStack;->mStacks:Ljava/util/ArrayList;
    ...
    const-string/jumbo v8, "moveHomeTask: topStack old="
    ...
    iget-object v1, v4, Lcom/android/server/am/ActivityStack;->mStackListener:Lcom/android/server/am/ActivityStackListener;

    .line 495
    .local v1, "stackListener":Lcom/android/server/am/ActivityStackListener;
    if-eqz v1, :cond_2
    ...
    invoke-virtual {v1, v4}, Lcom/android/server/am/ActivityStackListener;->dumpStack(Lcom/android/server/am/ActivityStack;)V

    .line 501
    .end local v1    # "stackListener":Lcom/android/server/am/ActivityStackListener;
    :cond_2
    if-eqz p3, :cond_3
    ...
    iget-boolean v4, v0, Lcom/android/server/am/ActivityRecord;->idle:Z
...
.method reportResumedActivityLocked(Lcom/android/server/am/ActivityRecord;)Z
    ...
    invoke-virtual {v1, v2, v3}, Lcom/mediatek/common/thermal/MtkThermalSwitchManager;->notifyAppState(Ljava/lang/String;Lcom/mediatek/common/thermal/MtkThermalSwitchManager$AppState;)Z
    ...
    invoke-virtual {v1}, Lcom/android/server/am/ActivityManagerService;->showThermalSwitchNotice()V
...
.method resolveActivity(Landroid/content/Intent;Ljava/lang/String;ILandroid/app/ProfilerInfo;I)Landroid/content/pm/ActivityInfo;
    ...
    invoke-interface {v3, v4}, Landroid/content/pm/IPackageManager;->isAppDouble(Ljava/lang/String;)Z

    move-result v3

    if-eqz v3, :cond_0

    const-string/jumbo v3, ".LetvClone"
    ...
    invoke-interface {v3, v2}, Landroid/content/pm/IPackageManager;->getCloneResolveInfo(Landroid/content/pm/ResolveInfo;)Landroid/content/pm/ResolveInfo;
    ...
    const-string/jumbo v5, "xulei call  startActivityAsUser  isAppDouble rInfo:"
...
.method final startActivityLocked(Landroid/app/IApplicationThread;Landroid/content/Intent;Ljava/lang/String;Landroid/content/pm/ActivityInfo;Landroid/service/voice/IVoiceInteractionSession;Lcom/android/internal/app/IVoiceInteractor;Landroid/os/IBinder;Ljava/lang/String;IIILjava/lang/String;IIILandroid/os/Bundle;ZZ[Lcom/android/server/am/ActivityRecord;Lcom/android/server/am/ActivityStackSupervisor$ActivityContainer;Lcom/android/server/am/TaskRecord;)I
    ...
    iget-object v5, v0, Lcom/android/server/am/ActivityStackSupervisor;->mPm:Landroid/content/pm/IPackageManager;
    ...
    iput-object v5, v0, Lcom/android/server/am/ActivityStackSupervisor;->mPm:Landroid/content/pm/IPackageManager;
    ...
    invoke-interface {v5, v0, v1}, Landroid/content/pm/IPackageManager;->setLaunchedPackage(Landroid/content/Intent;Ljava/lang/String;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string/jumbo v8, "launch app----- startActivityLocked::setLaunchedPackage exceprion"
    ...
    .line 1735
    .end local v26    # "actionRestriction":I
    ...
    .line 1725
    .local v25, "abort":Z
    .restart local v26    # "actionRestriction":I
    ...
    iget-boolean v5, v0, Landroid/content/pm/ActivityInfo;->isShadow:Z
    ...
    iput-boolean v5, v7, Lcom/android/server/am/ActivityRecord;->isShadow:Z
    ...
    const-string/jumbo v9, "xulei call startActivityLocked  is Clone !!! aInfo:"
...
.method final startActivityMayWait(Landroid/app/IApplicationThread;ILjava/lang/String;Landroid/content/Intent;Ljava/lang/String;Landroid/service/voice/IVoiceInteractionSession;Lcom/android/internal/app/IVoiceInteractor;Landroid/os/IBinder;Ljava/lang/String;IILandroid/app/ProfilerInfo;Landroid/app/IActivityManager$WaitResult;Landroid/content/res/Configuration;Landroid/os/Bundle;ZILandroid/app/IActivityContainer;Lcom/android/server/am/TaskRecord;)I
    ...
    const-string/jumbo v5, "startActivity now"
    ...
    const-string/jumbo v5, "startActivity() is not granted with permission: "
    ...
    const-string/jumbo v5, "Starting activity when config will change = "
    ...
    .line 1143
    const-string/jumbo v4, "Updating to new configuration after starting activity."
...
.method final startActivityUncheckedLocked(Lcom/android/server/am/ActivityRecord;Lcom/android/server/am/ActivityRecord;Landroid/service/voice/IVoiceInteractionSession;Lcom/android/internal/app/IVoiceInteractor;IZLandroid/os/Bundle;Lcom/android/server/am/TaskRecord;)I
    ...
    const-string/jumbo v8, " reuse task of intentActvity="
    ...
    const-string/jumbo v8, " for new activity"
    ...
    const-string/jumbo v8, "start task to front intentActivity="
    ...
    const-string/jumbo v8, " r.intent="
...
.method startSpecificActivityLocked(Lcom/android/server/am/ActivityRecord;ZZ)V
    ...
    const-string/jumbo v2, "xulei call isShadow startSpecificActivityLocked::app:"
