...
.method public constructor <init>(Lcom/android/server/am/ActivityManagerService;)V
    ...
    iput-object v3, p0, Lcom/android/server/am/ActiveServices;->mCachedServices:Landroid/util/ArraySet;
...
.method private final bringDownServiceLocked(Lcom/android/server/am/ServiceRecord;)V
    ...
    iget-boolean v10, p1, Lcom/android/server/am/ServiceRecord;->isShadow:Z

    if-eqz v10, :cond_7

    .line 2117
    iget-object v10, v7, Lcom/android/server/am/ActiveServices$ServiceMap;->mShadowServicesByName:Landroid/util/ArrayMap;
    ...
    .line 2118
    iget-object v10, v7, Lcom/android/server/am/ActiveServices$ServiceMap;->mShadowServicesByIntent:Landroid/util/ArrayMap;
...
.method private final bringUpServiceLocked(Lcom/android/server/am/ServiceRecord;IZZ)Ljava/lang/String;
    ...
    iget-boolean v4, v0, Lcom/android/server/am/ServiceRecord;->isShadow:Z
    ...
    const-string/jumbo v7, "xulei call getProcess app:"
...
.method private retrieveServiceLocked(Landroid/content/Intent;Ljava/lang/String;Ljava/lang/String;IIIZZ)Lcom/android/server/am/ActiveServices$ServiceLookupResult;
    ...
    const-string/jumbo v13, "retrieveServiceLocked: "
    ...
    .line 1291
    .local v31, "smap":Lcom/android/server/am/ActiveServices$ServiceMap;
    ...
    invoke-interface {v6, v0}, Landroid/content/pm/IPackageManager;->isAppDouble(Ljava/lang/String;)Z

    move-result v23

    .line 1300
    .local v23, "isDouble":Z
    if-eqz v23, :cond_1
    ...
    const-string/jumbo v13, "xulei call. retrieveServiceLocked Provider isDouble;"
    ...
    iget-object v6, v0, Lcom/android/server/am/ActiveServices$ServiceMap;->mShadowServicesByName:Landroid/util/ArrayMap;
    ...
    iget-object v6, v0, Lcom/android/server/am/ActiveServices$ServiceMap;->mShadowServicesByIntent:Landroid/util/ArrayMap;
    ...
    invoke-interface {v6, v0, v1, v11, v2}, Landroid/content/pm/IPackageManager;->resolveService(Landroid/content/Intent;Ljava/lang/String;II)Landroid/content/pm/ResolveInfo;
    ...
    .local v30, "sInfo":Landroid/content/pm/ServiceInfo;
    :goto_3
    if-nez v30, :cond_7
    ...
    const-string/jumbo v13, "Unable to start service "
    ...
    .end local v30    # "sInfo":Landroid/content/pm/ServiceInfo;
    ...
    const-string/jumbo v13, "xulei call. retrieveServiceLocked service intent hasCategory, but comp is null!!!, callingPid;"
    ...
    .restart local v30    # "sInfo":Landroid/content/pm/ServiceInfo;
    goto/16 :goto_3
    ...
    invoke-virtual {v0, v1, v2, v3, v4}, Lcom/android/server/am/ActiveServices;->isAllowAutoStart(Landroid/content/pm/ComponentInfo;III)Z
    ...
    const-string/jumbo v13, "don\'t allow to start "
    ...
    iget-object v11, v0, Landroid/content/pm/ServiceInfo;->processName:Ljava/lang/String;

    move-object/from16 v0, v30

    iget-object v13, v0, Landroid/content/pm/ServiceInfo;->applicationInfo:Landroid/content/pm/ApplicationInfo;

    .line 1352
    move-object/from16 v0, v30

    iget-object v14, v0, Landroid/content/pm/ServiceInfo;->name:Ljava/lang/String;
    ...
    .line 1351
    invoke-virtual {v6, v11, v13, v14, v15}, Lcom/android/server/am/ActivityManagerService;->isSingleton(Ljava/lang/String;Landroid/content/pm/ApplicationInfo;Ljava/lang/String;I)Z
    ...
    invoke-virtual {v6, v0, v11}, Lcom/android/server/am/ActivityManagerService;->isValidSingletonCall(II)Z
    ...
    invoke-direct {v10, v0}, Landroid/content/pm/ServiceInfo;-><init>(Landroid/content/pm/ServiceInfo;)V
    ...
    invoke-virtual {v6, v11, v0}, Lcom/android/server/am/ActivityManagerService;->getAppInfoForUser(Landroid/content/pm/ApplicationInfo;I)Landroid/content/pm/ApplicationInfo;

    move-result-object v6

    iput-object v6, v10, Landroid/content/pm/ServiceInfo;->applicationInfo:Landroid/content/pm/ApplicationInfo;
    ...
    invoke-direct {v12, v0, v6}, Lcom/android/server/am/ActiveServices$ServiceRestarter;-><init>(Lcom/android/server/am/ActiveServices;Lcom/android/server/am/ActiveServices$ServiceRestarter;)V
    ...
    .line 1376
    .local v32, "stats":Lcom/android/internal/os/BatteryStatsImpl;
    monitor-enter v32
    :try_end_3
    ...
    invoke-virtual {v0, v6, v11, v13}, Lcom/android/internal/os/BatteryStatsImpl;->getServiceStatsLocked(ILjava/lang/String;Ljava/lang/String;)Lcom/android/internal/os/BatteryStatsImpl$Uid$Pkg$Serv;
    :try_end_4
    .catchall {:try_start_4 .. :try_end_4} :catchall_0
    ...
    const-string/jumbo v13, "xulei call retrieveServiceLocked put clone servicesMap sInfo.name: "
    ...
    check-cast v27, Lcom/android/server/am/ServiceRecord;

    .line 1402
    .local v27, "pr":Lcom/android/server/am/ServiceRecord;
    move-object/from16 v0, v27

    iget-boolean v6, v0, Lcom/android/server/am/ServiceRecord;->isShadow:Z
    ...
    iget v11, v11, Landroid/content/pm/ApplicationInfo;->uidOffset:I
    ...
    iget v13, v13, Landroid/content/pm/ApplicationInfo;->uidOffset:I
    ...
    .end local v22    # "i":I
    .end local v27    # "pr":Lcom/android/server/am/ServiceRecord;
    .end local v32    # "stats":Lcom/android/internal/os/BatteryStatsImpl;
    :cond_b
    move-object/from16 v0, v31
    ...
    .line 1422
    iget-boolean v6, v5, Lcom/android/server/am/ServiceRecord;->exported:Z
    ...
    const-string/jumbo v13, "Permission Denial: Accessing service "

    invoke-virtual {v11, v13}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v11

    iget-object v13, v5, Lcom/android/server/am/ServiceRecord;->name:Landroid/content/ComponentName;
    ...
    .line 1424
    const-string/jumbo v13, " from pid="
    ...
    .line 1426
    const-string/jumbo v13, " that is not exported from uid "
    ...
    .line 1426
    iget-object v13, v5, Lcom/android/server/am/ServiceRecord;->appInfo:Landroid/content/pm/ApplicationInfo;
    ...
    .line 1427
    new-instance v6, Lcom/android/server/am/ActiveServices$ServiceLookupResult;
    ...
    invoke-direct {v6, v0, v13, v11}, Lcom/android/server/am/ActiveServices$ServiceLookupResult;-><init>(Lcom/android/server/am/ActiveServices;Lcom/android/server/am/ServiceRecord;Ljava/lang/String;)V
    ...
    .restart local v28    # "r":Lcom/android/server/am/ServiceRecord;
    .restart local v29    # "rInfo":Landroid/content/pm/ResolveInfo;
    .restart local v32    # "stats":Lcom/android/internal/os/BatteryStatsImpl;
    :catchall_0
    move-exception v6
    ...
    .restart local v27    # "pr":Lcom/android/server/am/ServiceRecord;
    .restart local v29    # "rInfo":Landroid/content/pm/ResolveInfo;
    .restart local v32    # "stats":Lcom/android/internal/os/BatteryStatsImpl;
    :cond_f
    move-object/from16 v0, v27
    ...
    .line 1433
    iget-object v13, v5, Lcom/android/server/am/ServiceRecord;->permission:Ljava/lang/String;
    ...
    iget-object v11, v5, Lcom/android/server/am/ServiceRecord;->permission:Ljava/lang/String;
    ...
    invoke-virtual {v6, v0, v1, v2}, Lcom/android/server/AppOpsService;->noteOperation(IILjava/lang/String;)I
    ...
    const-string/jumbo v13, "Appop Denial: Accessing service "
    ...
    .line 1442
    const-string/jumbo v13, " requires appop "
    ...
    iget-object v13, v6, Lcom/android/server/am/ActivityManagerService;->mIntentFirewall:Lcom/android/server/firewall/IntentFirewall;
    ...
    invoke-virtual {v0, v6, v1, v2, v3}, Lcom/android/server/am/ActiveServices;->isAllowAutoStart(Landroid/content/pm/ComponentInfo;III)Z
    ...
    invoke-direct {v6, v0, v5, v11}, Lcom/android/server/am/ActiveServices$ServiceLookupResult;-><init>(Lcom/android/server/am/ActiveServices;Lcom/android/server/am/ServiceRecord;Ljava/lang/String;)V
    ...
    iget-object v13, v5, Lcom/android/server/am/ServiceRecord;->serviceInfo:Landroid/content/pm/ServiceInfo;
...
.method private final scheduleServiceRestartLocked(Lcom/android/server/am/ServiceRecord;Z)Z
    ...
    iget-boolean v0, v0, Lcom/android/server/am/ServiceRecord;->isShadow:Z
    ...
    iget-object v0, v0, Lcom/android/server/am/ActiveServices$ServiceMap;->mShadowServicesByName:Landroid/util/ArrayMap;
...
.method attachApplicationLocked(Lcom/android/server/am/ProcessRecord;Ljava/lang/String;)Z
    ...
    .line 2449
    :cond_0
    iget-boolean v5, v4, Lcom/android/server/am/ServiceRecord;->isShadow:Z

    iget-boolean v6, p1, Lcom/android/server/am/ProcessRecord;->isShadow:Z
    ...
    const-string/jumbo v7, "xulei check attachApplicationLocked proc: "
    ...
    const-string/jumbo v7, "xulei check attachApplicationLocked 123 proc: "
...
.method bindServiceLocked(Landroid/app/IApplicationThread;Landroid/os/IBinder;Landroid/content/Intent;Ljava/lang/String;Landroid/app/IServiceConnection;ILjava/lang/String;I)I
    ...
    iget-boolean v4, v13, Lcom/android/server/am/ProcessRecord;->isShadow:Z

    if-eqz v4, :cond_3

    .line 819
    const-string/jumbo v4, ".LetvClone"
    ...
    const-string/jumbo v6, "xulei call  bindServiceLocked service:"
...
.method cleanUpRemovedTaskLocked(Lcom/android/server/am/TaskRecord;Landroid/content/ComponentName;Landroid/content/Intent;)V
    ...
    iget-boolean v0, p1, Lcom/android/server/am/TaskRecord;->isShadow:Z
    ...
    invoke-virtual {p0, v0}, Lcom/android/server/am/ActiveServices;->getShadowServices(I)Landroid/util/ArrayMap;
...
.method dumpServicesLocked(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;IZZLjava/lang/String;)V
    ...
    .line 3245
    .restart local v7    # "clist":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/android/server/am/ConnectionRecord;>;"
    const/4 v14, 0x0
    ...
    .line 3247
    .restart local v8    # "conn":Lcom/android/server/am/ConnectionRecord;
    const-string/jumbo v30, "      "
...
.method forceStopLocked(Ljava/lang/String;Ljava/util/Set;IZZZZ)Z
    .locals 10
    ...
    .restart local v6    # "items":Landroid/util/ArrayMap;, "Landroid/util/ArrayMap<Landroid/content/ComponentName;Lcom/android/server/am/ServiceRecord;>;"
    goto :goto_1
    ...
    .line 2581
    iget-object v6, v9, Lcom/android/server/am/ActiveServices$ServiceMap;->mShadowServicesByName:Landroid/util/ArrayMap;
...
.method getRunningServiceInfoLocked(II)Ljava/util/List;
    ...
    invoke-virtual {p0, v12}, Lcom/android/server/am/ActiveServices;->getShadowServices(I)Landroid/util/ArrayMap;
    ...
    .end local v7    # "sr":Lcom/android/server/am/ServiceRecord;
    :cond_5
    invoke-virtual {p0, v10}, Lcom/android/server/am/ActiveServices;->getShadowServices(I)Landroid/util/ArrayMap;
...
.method getServiceByName(Landroid/content/ComponentName;I)Lcom/android/server/am/ServiceRecord;
    ...
    const-string/jumbo v6, "getServiceByName("
    ...
    const-string/jumbo v6, "), callingUser = "
    ...
    invoke-virtual {v4, v3}, Lcom/android/server/am/ActivityManagerService;->isCloneProcessByPid(I)Z
    ...
    iget-object v4, v4, Lcom/android/server/am/ActiveServices$ServiceMap;->mShadowServicesByName:Landroid/util/ArrayMap;
    ...
    iget-object v4, v4, Lcom/android/server/am/ActiveServices$ServiceMap;->mServicesByName:Landroid/util/ArrayMap;
...
.method getShadowServices(I)Landroid/util/ArrayMap;
    .locals 1
    .param p1, "callingUser"    # I
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method isAllowAutoStart(Landroid/content/pm/ComponentInfo;III)Z
    .locals 15
    ...
    .line 1176
    .local v4, "cpmPkg":Ljava/lang/String;
    move-object/from16 v0, p1

    iget-object v12, v0, Landroid/content/pm/ComponentInfo;->applicationInfo:Landroid/content/pm/ApplicationInfo;

    iget-object v3, v12, Landroid/content/pm/ApplicationInfo;->processName:Ljava/lang/String;

    .line 1177
    .local v3, "cpmPcs":Ljava/lang/String;
    move-object/from16 v0, p1

    iget-object v12, v0, Landroid/content/pm/ComponentInfo;->applicationInfo:Landroid/content/pm/ApplicationInfo;

    iget v12, v12, Landroid/content/pm/ApplicationInfo;->flagsEx:I
    ...
    const-string/jumbo v14, "cpmInfo = "
    ...
    .line 1187
    const-string/jumbo v14, ", callingPid = "
    ...
    .line 1188
    const-string/jumbo v14, ", hasExOpFlag = "
    ...
    .line 1189
    const-string/jumbo v14, ", hasSystemFlag = "
    ...
    .line 1181
    invoke-static {v12, v13, v14}, Landroid/util/Slog;->w(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I

    .line 1194
    :cond_1
    invoke-direct {p0, v4}, Lcom/android/server/am/ActiveServices;->isSkipPackageName(Ljava/lang/String;)Z
    ...
    .line 1177
    .end local v8    # "hasExOpFlag":Z
    .end local v9    # "hasSystemFlag":Z
    :cond_2
    const/4 v8, 0x0

    .restart local v8    # "hasExOpFlag":Z
    goto/16 :goto_0
    ...
    .restart local v9    # "hasSystemFlag":Z
    goto/16 :goto_1
    ...
    const-string/jumbo v13, "com.letv.leui.cta"

    invoke-interface {v12, v13}, Landroid/content/pm/IPackageManager;->hasSystemFeature(Ljava/lang/String;)Z
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-virtual {p0, v0}, Lcom/android/server/am/ActiveServices;->isAllowStartFromTopActivity(I)Z
    ...
    const-string/jumbo v13, "allow to start cpm from top activity."
    ...
    const-string/jumbo v13, "allow to start cpm from itself."
    ...
    const-string/jumbo v13, "allow to start cpm from system."
    ...
    const-string/jumbo v13, "allow to start cpm from preset app or system app."
    ...
    invoke-virtual {v12, v4, v3}, Lcom/android/server/am/ActivityManagerService;->checkProcIsExist(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    const-string/jumbo v13, "allow to start cpm if its process exists."
    ...
    iget-object v12, v12, Lcom/android/server/am/ActivityManagerService;->mAppOpsService:Lcom/android/server/AppOpsService;

    const/16 v13, 0x46

    invoke-virtual {v12, v13, v5, v4}, Lcom/android/server/AppOpsService;->checkOperation(IILjava/lang/String;)I
    ...
    const-string/jumbo v13, "don\'t allow to start cpm."
    ...
    const-string/jumbo v13, "allow to start cpm for other situations."
    ...
    const-string/jumbo v14, " check operation error."
...
.method isAllowStartFromTopActivity(I)Z
    ...
    sget-boolean v5, Lcom/android/server/am/ActivityManagerDebugConfig;->DEBUG_PROVIDER:Z
...
.method final killServicesLocked(Lcom/android/server/am/ProcessRecord;Z)V
    ...
    iget-boolean v0, v0, Lcom/android/server/am/ProcessRecord;->isShadow:Z
    ...
    const-string/jumbo v24, "xulei check killServicesLocked  proc: "
    ...
    const-string/jumbo v24, "xulei check killServicesLocked 123 app: "
...
.method processStartTimedOutLocked(Lcom/android/server/am/ProcessRecord;)V
    ...
    .line 2506
    iget-boolean v2, v1, Lcom/android/server/am/ServiceRecord;->isShadow:Z

    iget-boolean v3, p1, Lcom/android/server/am/ProcessRecord;->isShadow:Z
    ...
    const-string/jumbo v4, "xulei check processStartTimedOutLocked 123 proc: "
...
.method startServiceLocked(Landroid/app/IApplicationThread;Landroid/content/Intent;Ljava/lang/String;IILjava/lang/String;I)Landroid/content/ComponentName;
    ...
    iget-boolean v2, v0, Lcom/android/server/am/ProcessRecord;->isShadow:Z
    ...
    const-string/jumbo v4, "xulei call  startServiceLocked  clone service:"
    ...
    iget-boolean v2, v14, Lcom/android/server/am/ServiceRecord;->isShadow:Z
    ...
    const-string/jumbo v4, "xulei call getProcess proc:"
    ...
    const-string/jumbo v4, ", prcessName:"

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v3

    iget-object v4, v14, Lcom/android/server/am/ServiceRecord;->processName:Ljava/lang/String;
...
.method stopServiceLocked(Landroid/app/IApplicationThread;Landroid/content/Intent;Ljava/lang/String;I)I
    ...
    .line 574
    :cond_1
    iget-boolean v2, v11, Lcom/android/server/am/ProcessRecord;->isShadow:Z
