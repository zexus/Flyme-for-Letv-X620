...
.field private static final NOTIFICATION_IN_CALL_SOUND_FILE_PATH:Ljava/lang/String; = "/system/media/audio/ui/notification_in_call.ogg"
...
# instance fields
.field private COM_TENCENT_MM:Ljava/lang/String;

.field private final DOUBLE_APP_URI:Landroid/net/Uri;
...
.field private mInCallSoundId:I

.field private mInCallSoundPool:Landroid/media/SoundPool;
...
.field private mLetvLedLightNotificationPolicy:Z

.field private mLetvNotificationInCallPolicy:Z

.field private mLeuiNotificationHelper:Lbase/core/java/com/letv/leui/notification/LeuiNotificationHelper;
...
.method static synthetic -get0(Lcom/android/server/notification/NotificationManagerService;)Ljava/lang/String;
    ...
    iget-object v0, p0, Lcom/android/server/notification/NotificationManagerService;->COM_TENCENT_MM:Ljava/lang/String;

    return-object v0
.end method

.method static synthetic -get1(Lcom/android/server/notification/NotificationManagerService;)Landroid/net/Uri;
    .locals 1

    iget-object v0, p0, Lcom/android/server/notification/NotificationManagerService;->DOUBLE_APP_URI:Landroid/net/Uri;
...
.method static synthetic -get12(Lcom/android/server/notification/NotificationManagerService;)Lbase/core/java/com/letv/leui/notification/LeuiNotificationHelper;
    .locals 1

    iget-object v0, p0, Lcom/android/server/notification/NotificationManagerService;->mLeuiNotificationHelper:Lbase/core/java/com/letv/leui/notification/LeuiNotificationHelper;
...
.method static synthetic -get15(Lcom/android/server/notification/NotificationManagerService;)Landroid/util/ArraySet;
    .locals 1
...
.method static synthetic -wrap3(Lcom/android/server/notification/NotificationManagerService;I)Z
    .locals 1
    .param p1, "CallPid"    # I

    .prologue
    invoke-direct {p0, p1}, Lcom/android/server/notification/NotificationManagerService;->isCloneProcessByPid(I)Z
...
.method static synthetic -wrap30(Lcom/android/server/notification/NotificationManagerService;Ljava/io/OutputStream;Z)V
    .locals 0
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 264
    iput-boolean v3, p0, Lcom/android/server/notification/NotificationManagerService;->mLetvLedLightNotificationPolicy:Z

    .line 269
    iput-boolean v3, p0, Lcom/android/server/notification/NotificationManagerService;->mLetvNotificationInCallPolicy:Z
    ...
    iput-object v0, p0, Lcom/android/server/notification/NotificationManagerService;->COM_TENCENT_MM:Ljava/lang/String;

    const-string v0, "leui_wei_xin_double_setting"

    invoke-static {v0}, Landroid/provider/Settings$System;->getUriFor(Ljava/lang/String;)Landroid/net/Uri;

    move-result-object v0

    iput-object v0, p0, Lcom/android/server/notification/NotificationManagerService;->DOUBLE_APP_URI:Landroid/net/Uri;
...
.method private buzzBeepBlinkLocked(Lcom/android/server/notification/NotificationRecord;)V
    ...
    .line 2601
    .local v21, "enableAlerts":Z
    :goto_2
    invoke-direct/range {p0 .. p0}, Lcom/android/server/notification/NotificationManagerService;->isNotificationInCallMode()Z
    ...
    iget-boolean v4, v0, Lcom/android/server/notification/NotificationManagerService;->mLetvLedLightNotificationPolicy:Z
    ...
    iget-object v4, v0, Lcom/android/server/notification/NotificationManagerService;->mLeuiNotificationHelper:Lbase/core/java/com/letv/leui/notification/LeuiNotificationHelper;
    ...
    invoke-virtual {v4, v0, v5, v6}, Lbase/core/java/com/letv/leui/notification/LeuiNotificationHelper;->updateNotificationScreenTurningOn(Landroid/app/Notification;ZI)V
    ...
    .restart local v21    # "enableAlerts":Z
    goto/16 :goto_2
    ...
    iget v4, v0, Lcom/android/server/notification/NotificationManagerService;->mInCallSoundId:I
    ...
    iget-object v4, v0, Lcom/android/server/notification/NotificationManagerService;->mInCallSoundPool:Landroid/media/SoundPool;
    ...
    iget v5, v0, Lcom/android/server/notification/NotificationManagerService;->mInCallSoundId:I
...
.method private isCloneProcessByPid(I)Z
    .locals 4
    .param p1, "CallPid"    # I

    .prologue
    .line 3589
    iget-object v1, p0, Lcom/android/server/notification/NotificationManagerService;->mAm:Landroid/app/IActivityManager;
    ...
    invoke-interface {v1, p1}, Landroid/app/IActivityManager;->isCloneProcessByPid(I)Z
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string/jumbo v3, "is Exception \n"
...
.method private isHistoryLightOn()Z
    .locals 12
    ...
    .line 3421
    const-string/jumbo v7, "leui.privilegeShowingLight"
    ...
    const-string/jumbo v9, "isHistoryLightOn, pkg: "
    ...
    const-string/jumbo v9, ", isPrivileged: "
    ...
    .line 3427
    const-string/jumbo v9, ", isLedSwitchOn: "
    ...
    .line 3427
    const-string/jumbo v9, ", mNotificationPulseEnabled:"
    ...
    const-string/jumbo v8, "privileged app and the history light was on, so still show led light"
    ...
    .line 3424
    .restart local v2    # "isLedSwitchOn":Z
    .local v3, "isPrivileged":Z
    :cond_2
    const-string/jumbo v7, "NotificationService"

    const-string/jumbo v8, "isHistoryLightOn, waring: bundle is null"
    ...
    const-string/jumbo v8, "other app and the history light was on, so still show led light"
...
.method private isNotificationInCallMode()Z
    .locals 1

    .prologue
    .line 2766
    iget-boolean v0, p0, Lcom/android/server/notification/NotificationManagerService;->mLetvNotificationInCallPolicy:Z
...
.method cancelAllNotificationsInt(IILjava/lang/String;IIZIILcom/android/server/notification/ManagedServices$ManagedServiceInfo;Z)Z
    .locals 15
    .param p1, "callingUid"    # I
    .param p2, "callingPid"    # I
    .param p3, "pkg"    # Ljava/lang/String;
    ...
    iget-boolean v1, v1, Landroid/app/Notification;->isShadow:Z
...
.method cancelNotification(IILjava/lang/String;Ljava/lang/String;IIIZIILcom/android/server/notification/ManagedServices$ManagedServiceInfo;Z)V
    .locals 26
    .param p1, "callingUid"    # I
    .param p2, "callingPid"    # I
    .param p3, "pkg"    # Ljava/lang/String;
    ...
    const-string/jumbo v4, "cancelNotification, pkg: "
    ...
    invoke-direct {v0, v1}, Lcom/android/server/notification/NotificationManagerService;->isCloneProcessByPid(I)Z
    ...
    .line 3166
    invoke-virtual/range {v2 .. v7}, Lcom/android/server/notification/NotificationManagerService;->indexOfNotificationLocked(Ljava/lang/String;Ljava/lang/String;IIZ)I
    ...
    .line 3169
    .local v25, "target":Landroid/app/Notification;
    ...
    .line 3171
    .local v21, "contentTitle":Ljava/lang/String;
    :goto_1
    const-string/jumbo v2, "NotificationService"
    ...
    .line 3172
    const-string/jumbo v2, "notify#9"
    ...
    const-string/jumbo v4, "Found notification, callingUid: "
    ...
    .end local v21    # "contentTitle":Ljava/lang/String;
    .end local v25    # "target":Landroid/app/Notification;
    :cond_0
    monitor-exit v8
    ...
    new-instance v8, Lcom/android/server/notification/NotificationManagerService$9;
    ...
    invoke-direct/range {v8 .. v20}, Lcom/android/server/notification/NotificationManagerService$9;-><init>(Lcom/android/server/notification/NotificationManagerService;Lcom/android/server/notification/ManagedServices$ManagedServiceInfo;IILjava/lang/String;ILjava/lang/String;IIIIZ)V
    ...
    .local v7, "isShadowProc":Z
    goto/16 :goto_0

    .line 3170
    .end local v7    # "isShadowProc":Z
    .restart local v25    # "target":Landroid/app/Notification;
    :cond_4
    :try_start_2
    ...
    .restart local v21    # "contentTitle":Ljava/lang/String;
    goto/16 :goto_1
    ...
    .local v22, "exception":Ljava/lang/InterruptedException;
    goto :goto_2
.end method
...
.method dumpImpl(Ljava/io/PrintWriter;Lcom/android/server/notification/NotificationManagerService$DumpFilter;)V
    ...
    iget-object v0, v0, Lcom/android/server/notification/NotificationManagerService;->mLeuiNotificationHelper:Lbase/core/java/com/letv/leui/notification/LeuiNotificationHelper;
    ...
    invoke-virtual {v0, v1}, Lbase/core/java/com/letv/leui/notification/LeuiNotificationHelper;->dumpNotificationSubscript(Ljava/io/PrintWriter;)V
...
.method enqueueNotificationInternal(Ljava/lang/String;Ljava/lang/String;IILjava/lang/String;ILandroid/app/Notification;[II)V
    ...
    .line 2241
    const-string/jumbo v4, "binderPid:"
    ...
    iput-boolean v2, v0, Landroid/app/Notification;->isShadow:Z
    ...
    invoke-direct/range {v2 .. v13}, Lcom/android/server/notification/NotificationManagerService$8;-><init>(Lcom/android/server/notification/NotificationManagerService;Landroid/app/Notification;Ljava/lang/String;ILjava/lang/String;ILjava/lang/String;ILandroid/os/UserHandle;IZ)V
...
.method indexOfNotificationLocked(Ljava/lang/String;Ljava/lang/String;II)I
    ...
    invoke-virtual/range {v0 .. v5}, Lcom/android/server/notification/NotificationManagerService;->indexOfNotificationLocked(Ljava/lang/String;Ljava/lang/String;IIZ)I
...
.method indexOfNotificationLocked(Ljava/lang/String;Ljava/lang/String;IIZ)I
    .locals 5
    .param p1, "pkg"    # Ljava/lang/String;
    .param p2, "tag"    # Ljava/lang/String;
    .param p3, "id"    # I
    ...
    iget-boolean v4, v4, Landroid/app/Notification;->isShadow:Z
...
.method public onStart()V
    ...
    .line 961
    invoke-direct {v1, v2, v3, v5, v15}, Lcom/android/server/notification/RankingHelper;-><init>(Landroid/content/Context;Landroid/os/Handler;Lcom/android/server/notification/NotificationUsageStats;[Ljava/lang/String;)V
    ...
    const v1, #android:bool@le_led_light_notification_policy#t
    ...
    iput-boolean v1, v0, Lcom/android/server/notification/NotificationManagerService;->mLetvLedLightNotificationPolicy:Z
    ...
    const v1, #android:bool@le_notification_in_call_policy#t
    ...
    iput-boolean v1, v0, Lcom/android/server/notification/NotificationManagerService;->mLetvNotificationInCallPolicy:Z
    ...
    iput-object v1, v0, Lcom/android/server/notification/NotificationManagerService;->mInCallSoundPool:Landroid/media/SoundPool;

    .line 1026
    new-instance v1, Ljava/io/File;

    const-string/jumbo v2, "/system/media/audio/ui/notification_in_call.ogg"
    ...
    iget-object v1, v0, Lcom/android/server/notification/NotificationManagerService;->mInCallSoundPool:Landroid/media/SoundPool;
    ...
    iput v1, v0, Lcom/android/server/notification/NotificationManagerService;->mInCallSoundId:I
    ...
    new-instance v1, Lbase/core/java/com/letv/leui/notification/LeuiNotificationHelper;
    ...
    invoke-direct {v1, v2, v3, v5}, Lbase/core/java/com/letv/leui/notification/LeuiNotificationHelper;-><init>(Landroid/content/Context;Landroid/os/Looper;Ljava/util/HashMap;)V

    move-object/from16 v0, p0

    iput-object v1, v0, Lcom/android/server/notification/NotificationManagerService;->mLeuiNotificationHelper:Lbase/core/java/com/letv/leui/notification/LeuiNotificationHelper;

    .line 1103
    move-object/from16 v0, p0

    iget-object v1, v0, Lcom/android/server/notification/NotificationManagerService;->mLeuiNotificationHelper:Lbase/core/java/com/letv/leui/notification/LeuiNotificationHelper;
...
.method updateLightsLocked()V
    ...
    .line 3473
    .local v2, "ledOffMS":I
    iget-boolean v6, p0, Lcom/android/server/notification/NotificationManagerService;->mLetvLedLightNotificationPolicy:Z
    ...
    const-string/jumbo v7, "updateLightsLocked, force use default color and time"
    ...
    .line 3491
    invoke-direct {p0}, Lcom/android/server/notification/NotificationManagerService;->isHistoryLightOn()Z
    ...
    invoke-virtual {v6, v0, v9, v3, v2}, Lcom/android/server/lights/Light;->setFlashing(IIII)V
