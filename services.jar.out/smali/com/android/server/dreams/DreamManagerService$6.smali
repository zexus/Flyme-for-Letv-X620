...
.method constructor <init>(Lcom/android/server/dreams/DreamManagerService;Landroid/os/Binder;Landroid/content/ComponentName;ZZI)V
    ...
    iput-object p2, p0, Lcom/android/server/dreams/DreamManagerService$6;->val$newToken:Landroid/os/Binder;

    iput-object p3, p0, Lcom/android/server/dreams/DreamManagerService$6;->val$name:Landroid/content/ComponentName;

    iput-boolean p4, p0, Lcom/android/server/dreams/DreamManagerService$6;->val$isTest:Z

    iput-boolean p5, p0, Lcom/android/server/dreams/DreamManagerService$6;->val$canDoze:Z

    iput p6, p0, Lcom/android/server/dreams/DreamManagerService$6;->val$userId:I
...
.method public run()V
    ...
    iget-object v1, p0, Lcom/android/server/dreams/DreamManagerService$6;->val$newToken:Landroid/os/Binder;

    iget-object v2, p0, Lcom/android/server/dreams/DreamManagerService$6;->val$name:Landroid/content/ComponentName;

    iget-boolean v3, p0, Lcom/android/server/dreams/DreamManagerService$6;->val$isTest:Z

    iget-boolean v4, p0, Lcom/android/server/dreams/DreamManagerService$6;->val$canDoze:Z

    iget v5, p0, Lcom/android/server/dreams/DreamManagerService$6;->val$userId:I
