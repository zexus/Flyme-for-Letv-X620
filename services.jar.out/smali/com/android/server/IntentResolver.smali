...
.method public queryIntent(Landroid/content/Intent;Ljava/lang/String;ZI)Ljava/util/List;
    ...
    .line 413
    .local v38, "baseType":Ljava/lang/String;
    ...
    .end local v18    # "secondTypeCut":[Landroid/content/IntentFilter;, "[TF;"
    .end local v26    # "thirdTypeCut":[Landroid/content/IntentFilter;, "[TF;"
    .end local v38    # "baseType":Ljava/lang/String;
    .end local v41    # "slashpos":I
    :cond_4
    :goto_2
    if-eqz v8, :cond_5
    ...
    .end local v9    # "firstTypeCut":[Landroid/content/IntentFilter;, "[TF;"
    :cond_6
    const-string/jumbo v37, ".LetvClone"

    .line 464
    .local v37, "LETV_CLONE":Ljava/lang/String;
    const/16 v40, 0x0

    .line 465
    .local v40, "isRemove":Z
    move-object/from16 v0, p1
    ...
    .end local v37    # "LETV_CLONE":Ljava/lang/String;
    .end local v39    # "i":I
    .end local v40    # "isRemove":Z
    :cond_c
    const/4 v5, 0x0
    ...
    .local v26, "thirdTypeCut":[Landroid/content/IntentFilter;, "[TF;"
    .local v34, "schemeCut":[Landroid/content/IntentFilter;, "[TF;"
    .restart local v38    # "baseType":Ljava/lang/String;
    .restart local v41    # "slashpos":I
    :cond_d
    move-object/from16 v0, p0
    ...
    .restart local v37    # "LETV_CLONE":Ljava/lang/String;
    .restart local v40    # "isRemove":Z
    :cond_10
    if-eqz v40, :cond_11
...
.method public queryIntentFromList(Landroid/content/Intent;Ljava/lang/String;ZLjava/util/ArrayList;I)Ljava/util/List;
    ...
    .local v4, "debug":Z
    :goto_0
    const-string/jumbo v11, ".LetvClone"

    .line 363
    .local v11, "LETV_CLONE":Ljava/lang/String;
    const/4 v14, 0x0

    .line 364
    .local v14, "isRemove":Z
    move-object/from16 v0, p1
    ...
    invoke-virtual {v0, v11}, Landroid/content/Intent;->removeCategory(Ljava/lang/String;)V
    ...
    .end local v11    # "LETV_CLONE":Ljava/lang/String;
    .end local v12    # "N":I
    .end local v13    # "i":I
    .end local v14    # "isRemove":Z
    :cond_1
    const/4 v4, 0x0
    ...
    .restart local v11    # "LETV_CLONE":Ljava/lang/String;
    .restart local v12    # "N":I
    .restart local v13    # "i":I
    .restart local v14    # "isRemove":Z
    :cond_2
