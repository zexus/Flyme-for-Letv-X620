...
.method constructor <init>(Lcom/android/server/pm/PackageManagerService;Ljava/util/concurrent/CountDownLatch;JLjava/io/File;JI)V
    ...
    iput-wide p3, p0, Lcom/android/server/pm/PackageManagerService$24;->val$startFreeBytes:J

    iput-object p5, p0, Lcom/android/server/pm/PackageManagerService$24;->val$measurePath:Ljava/io/File;

    iput-wide p6, p0, Lcom/android/server/pm/PackageManagerService$24;->val$sizeBytes:J

    iput p8, p0, Lcom/android/server/pm/PackageManagerService$24;->val$moveId:I
...
.method public run()V
    ...
    :goto_0
    :try_start_0
    iget-object v0, p0, Lcom/android/server/pm/PackageManagerService$24;->val$installedLatch:Ljava/util/concurrent/CountDownLatch;
    ...
    .line 17280
    :cond_0
    iget-wide v0, p0, Lcom/android/server/pm/PackageManagerService$24;->val$startFreeBytes:J

    iget-object v2, p0, Lcom/android/server/pm/PackageManagerService$24;->val$measurePath:Ljava/io/File;
    ...
    iget-wide v2, p0, Lcom/android/server/pm/PackageManagerService$24;->val$sizeBytes:J
    ...
    iget v1, p0, Lcom/android/server/pm/PackageManagerService$24;->val$moveId:I
