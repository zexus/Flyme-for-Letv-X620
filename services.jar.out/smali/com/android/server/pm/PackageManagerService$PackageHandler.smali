...
.method private connectToService()Z
    ...
    invoke-static {v5}, Lcom/android/server/pm/PackageManagerService;->-get7(Lcom/android/server/pm/PackageManagerService;)Lcom/android/server/pm/PackageManagerService$DefaultContainerConnection;
...
.method private disconnectService()V
    ...
    invoke-static {v1}, Lcom/android/server/pm/PackageManagerService;->-get7(Lcom/android/server/pm/PackageManagerService;)Lcom/android/server/pm/PackageManagerService$DefaultContainerConnection;
...
.method doHandleMessage(Landroid/os/Message;)V
    ...
    invoke-static {v2}, Lcom/android/server/pm/PackageManagerService;->-get6(Lcom/android/server/pm/PackageManagerService;)Lcom/android/internal/app/IMediaContainerService;
    ...
    .local v44, "params$iterator":Ljava/util/Iterator;
    :goto_1
    ...
    .line 1327
    .end local v44    # "params$iterator":Ljava/util/Iterator;
    :cond_7
    const-string/jumbo v2, "PackageManager"
    ...
    invoke-static {v2}, Lcom/android/server/pm/PackageManagerService;->-get13(Lcom/android/server/pm/PackageManagerService;)I
    ...
    invoke-static {v6}, Lcom/android/server/pm/PackageManagerService;->-get14(Lcom/android/server/pm/PackageManagerService;)Z
    ...
    invoke-static {v6}, Lcom/android/server/pm/PackageManagerService;->-get13(Lcom/android/server/pm/PackageManagerService;)I
    ...
    .restart local v44    # "params$iterator":Ljava/util/Iterator;
    :goto_2
    invoke-interface/range {v44 .. v44}, Ljava/util/Iterator;->hasNext()Z
    ...
    aget-object v3, v41, v31

    aget-object v6, v25, v31

    aget v7, v55, v31

    const/4 v9, 0x1

    invoke-static {v2, v3, v9, v6, v7}, Lcom/android/server/pm/PackageManagerService;->-wrap34(Lcom/android/server/pm/PackageManagerService;Ljava/lang/String;ZLjava/util/ArrayList;I)V
    ...
    .line 1464
    .restart local v25    # "components":[Ljava/util/ArrayList;, "[Ljava/util/ArrayList<Ljava/lang/String;>;"
    .restart local v31    # "i":I
    .restart local v36    # "n":I
    .restart local v41    # "packages":[Ljava/lang/String;
    .restart local v55    # "uids":[I
    :cond_1c
    const/16 v2, 0xa
    ...
    .line 1567
    invoke-static/range {v9 .. v14}, Lcom/android/server/pm/PackageManagerService;->-wrap35(Lcom/android/server/pm/PackageManagerService;ZZLjava/util/ArrayList;[ILandroid/content/IIntentReceiver;)V
    ...
    invoke-static {v2, v4, v3, v6}, Lcom/android/server/pm/PackageManagerService;->-wrap36(Lcom/android/server/pm/PackageManagerService;Ljava/lang/String;ILjava/lang/String;)V
    ...
    .line 1604
    const-string/jumbo v18, "upgrade"
    ...
    invoke-static {v2}, Lcom/android/server/pm/PackageManagerService;->-get5(Lcom/android/server/pm/PackageManagerService;)Lcom/letv/tracker/agnes/App;

    move-result-object v17

    invoke-static/range {v16 .. v21}, Lcom/android/server/pm/PackageManagerService;->-wrap33(Lcom/android/server/pm/PackageManagerService;Lcom/letv/tracker/agnes/App;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;I)V
    ...
    .line 1606
    :cond_33
    const-string/jumbo v18, "install"
    ...
    invoke-static {v2}, Lcom/android/server/pm/PackageManagerService;->-get8(Lcom/android/server/pm/PackageManagerService;)Landroid/util/ArraySet;
    ...
    .local v59, "userId$iterator":Ljava/util/Iterator;
    :goto_12
    ...
    .line 1671
    .end local v58    # "userId":I
    .end local v59    # "userId$iterator":Ljava/util/Iterator;
    :catchall_5
    move-exception v2
    ...
    .line 1676
    .restart local v59    # "userId$iterator":Ljava/util/Iterator;
    :cond_3d
    :try_start_a
    move-object/from16 v0, p0
    ...
    check-cast v43, Lcom/android/server/pm/PackageManagerService$IFVerificationParams;

    .line 1758
    .local v43, "params":Lcom/android/server/pm/PackageManagerService$IFVerificationParams;
    move-object/from16 v0, p0
    ...
    .line 1763
    .end local v43    # "params":Lcom/android/server/pm/PackageManagerService$IFVerificationParams;
    :pswitch_10
    move-object/from16 v0, p1
    ...
    check-cast v48, Lcom/android/server/pm/IntentFilterVerificationResponse;

    .line 1782
    .local v48, "response":Lcom/android/server/pm/IntentFilterVerificationResponse;
    ...
    .line 1792
    invoke-virtual/range {v48 .. v48}, Lcom/android/server/pm/IntentFilterVerificationResponse;->getFailedDomainsString()Ljava/lang/String;
    ...
    invoke-static {v2}, Lcom/android/server/pm/PackageManagerService;->-get9(Lcom/android/server/pm/PackageManagerService;)Lcom/android/server/pm/PackageManagerService$IntentFilterVerifier;
