...
.method static synthetic -wrap12(Lcom/android/server/MountService;Z)V
    .locals 0
...
.method static synthetic -wrap14(Lcom/android/server/MountService;I)V
    .locals 0
    .param p1, "userId"    # I
...
.method static synthetic -wrap15(Lcom/android/server/MountService;II)V
    .locals 0
    .param p1, "uid"    # I
    .param p2, "mode"    # I
...
.method static synthetic -wrap16(Lcom/android/server/MountService;Lcom/android/server/MountService$ObbState;)V
    .locals 0
...
.method static synthetic -wrap17(Lcom/android/server/MountService;Landroid/os/storage/VolumeInfo;)V
    .locals 0
    .param p1, "vol"    # Landroid/os/storage/VolumeInfo;

    .prologue
    invoke-direct {p0, p1}, Lcom/android/server/MountService;->showDefaultPathDialog(Landroid/os/storage/VolumeInfo;)V
...
.method static synthetic -wrap2(Lcom/android/server/MountService;Landroid/os/storage/VolumeInfo;)Z
    ...
    .prologue
    invoke-direct {p0, p1}, Lcom/android/server/MountService;->isShowDefaultPathDialog(Landroid/os/storage/VolumeInfo;)Z
...
.method static synthetic -wrap22(Lcom/android/server/MountService;)V
    .locals 0
...
.method static synthetic -wrap23(Lcom/android/server/MountService;)V
    .locals 0
...
.method static synthetic -wrap3(Lcom/android/server/MountService;Ljava/lang/String;I)Z
    .locals 1
...
.method static synthetic -wrap4(Lcom/android/server/MountService;)Z
    .locals 1
...
.method static synthetic -wrap5(Lcom/android/server/MountService;)Ljava/lang/String;
    .locals 1
...
.method static synthetic -wrap6(Lcom/android/server/MountService;Lcom/android/server/MountService$ObbState;)V
    .locals 0
    .param p1, "obbState"    # Lcom/android/server/MountService$ObbState;
...
.method static synthetic -wrap7(Lcom/android/server/MountService;Ljava/lang/String;Z)V
    .locals 0
...
.method static synthetic -wrap8(Lcom/android/server/MountService;Z)V
    .locals 0
    .param p1, "enable"    # Z
...
.method private onVolumeStateChangedLocked(Landroid/os/storage/VolumeInfo;II)V
    ...
    const-string/jumbo v18, "onVolumeStateChangedLocked, oldState="
    ...
    .line 1348
    const-string/jumbo v18, ", volumeInfo="
    ...
    invoke-static {v0, v1, v2, v3}, Lcom/android/server/MountService$Callbacks;->-wrap5(Lcom/android/server/MountService$Callbacks;Landroid/os/storage/VolumeInfo;II)V
    ...
    const-string/jumbo v16, "android.os.storage.action.VOLUME_STATE_CHANGED"
    ...
    const-string/jumbo v16, "android.os.storage.extra.VOLUME_ID"
    ...
    .line 1376
    const-string/jumbo v16, "android.os.storage.extra.VOLUME_STATE"
    ...
    .line 1377
    const-string/jumbo v16, "android.os.storage.extra.FS_UUID"
    ...
    const-string/jumbo v18, "sendBroadcastAsUser, intent="
    ...
    .line 1383
    const-string/jumbo v18, ", vol.fsUuid="
    ...
    .line 1384
    const-string/jumbo v18, ", flags=FLAG_RECEIVER_REGISTERED_ONLY_BEFORE_BOOT"
    ...
    const-string/jumbo v17, "send eject broadcast quickly, when new state is ejecting"
    ...
    iget-object v0, v0, Lcom/android/server/MountService;->mStartedUsers:[I
    ...
    invoke-virtual {v0, v14}, Landroid/os/storage/VolumeInfo;->isVisibleForRead(I)Z
    ...
    invoke-virtual {v0, v1, v14, v2}, Landroid/os/storage/VolumeInfo;->buildStorageVolume(Landroid/content/Context;IZ)Landroid/os/storage/StorageVolume;
    ...
    const-string/jumbo v19, "android.intent.action.MEDIA_EJECT"
    ...
    .line 1353
    .local v12, "rec":Landroid/os/storage/VolumeRecord;
    if-nez v12, :cond_4

    .line 1354
    new-instance v12, Landroid/os/storage/VolumeRecord;

    .end local v12    # "rec":Landroid/os/storage/VolumeRecord;
    move-object/from16 v0, p1
    ...
    invoke-direct {v12, v0, v1}, Landroid/os/storage/VolumeRecord;-><init>(ILjava/lang/String;)V

    .line 1355
    .restart local v12    # "rec":Landroid/os/storage/VolumeRecord;
    move-object/from16 v0, p1
    ...
    iput-object v0, v12, Landroid/os/storage/VolumeRecord;->partGuid:Ljava/lang/String;
    ...
    iput-wide v0, v12, Landroid/os/storage/VolumeRecord;->createdMillis:J
    ...
    iput-object v0, v12, Landroid/os/storage/VolumeRecord;->nickname:Ljava/lang/String;
    ...
    iget-object v0, v12, Landroid/os/storage/VolumeRecord;->fsUuid:Ljava/lang/String;
    ...
    .line 1364
    :cond_4
    iget-object v0, v12, Landroid/os/storage/VolumeRecord;->partGuid:Ljava/lang/String;
    ...
    .line 1416
    .restart local v15    # "userVol":Landroid/os/storage/StorageVolume;
    move-object/from16 v0, p0
    ...
    const-string/jumbo v21, "notify callbacks StorageStateChanged, storageVolume="
    ...
    invoke-static {v0, v1, v9, v8}, Lcom/android/server/MountService$Callbacks;->-wrap2(Lcom/android/server/MountService$Callbacks;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v11, v0, Landroid/os/storage/VolumeInfo;->path:Ljava/lang/String;
    ...
    const-string/jumbo v17, "type is TYPE_PUBLIC"
    ...
    const-string/jumbo v17, "type is Visible"
    ...
    .line 1439
    new-instance v10, Lcom/letv/storage/OtgGuideDialog;
    ...
    invoke-direct {v10, v0, v6, v11}, Lcom/letv/storage/OtgGuideDialog;-><init>(Landroid/content/Context;ZLjava/lang/String;)V

    .line 1453
    .end local v6    # "isOtgStorage":Z
    ...
    invoke-virtual {v0, v1, v2}, Lcom/android/server/MountService$ObbActionHandler;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;

    move-result-object v17

    invoke-virtual/range {v16 .. v17}, Lcom/android/server/MountService$ObbActionHandler;->sendMessage(Landroid/os/Message;)Z
    ...
    .line 1441
    .restart local v6    # "isOtgStorage":Z
    ...
    const-string/jumbo v17, "type is not Visible"
    ...
    const-string/jumbo v17, "type is not TYPE_PUBLIC"
...
.method private waitMTKNetlogStopped()V
    .locals 6
    ...
    const-string/jumbo v4, "waitMTKNetlogStopped..."
    ...
    .line 4626
    .local v2, "tryCount":I
    const-string/jumbo v1, "debug.mtklog.netlog.Running"

    .line 4627
    .local v1, "netlog":Ljava/lang/String;
    :goto_0
    const-string/jumbo v3, "debug.mtklog.netlog.Running"
    ...
    const-string/jumbo v4, "try count = 60, break"
    ...
    const-string/jumbo v4, "waitMTKNetlogStopped done"
    ...
    const-string/jumbo v5, "debug.mtklog.netlog.Running="
...
.method private waitMtkLogStopped()V
    .locals 15
    ...
    const-string/jumbo v12, "waitMtkLogStopped..."
    ...
    .line 3869
    .local v3, "emulatedVolume":Landroid/os/storage/VolumeInfo;
    iget-object v12, p0, Lcom/android/server/MountService;->mLock:Ljava/lang/Object;
    ...
    :goto_0
    :try_start_0
    iget-object v11, p0, Lcom/android/server/MountService;->mVolumes:Landroid/util/ArrayMap;
    ...
    .end local v3    # "emulatedVolume":Landroid/os/storage/VolumeInfo;
    ...
    const-string/jumbo v12, "cannot find emulated volume, return"
    ...
    .line 3870
    .restart local v3    # "emulatedVolume":Landroid/os/storage/VolumeInfo;
    .restart local v10    # "vol":Landroid/os/storage/VolumeInfo;
    :cond_1
    add-int/lit8 v4, v4, 0x1
    ...
    iget v12, p0, Lcom/android/server/MountService;->mCurrentUserId:I

    const/4 v13, 0x0

    .line 3884
    invoke-virtual {v3, v11, v12, v13}, Landroid/os/storage/VolumeInfo;->buildStorageVolume(Landroid/content/Context;IZ)Landroid/os/storage/StorageVolume;
    ...
    .line 3887
    invoke-virtual {v9}, Landroid/os/storage/StorageVolume;->getPathFile()Ljava/io/File;
    ...
    invoke-virtual {v5, v11, v9}, Landroid/content/Intent;->putExtra(Ljava/lang/String;Landroid/os/Parcelable;)Landroid/content/Intent;
    ...
    .line 3891
    const-string/jumbo v13, ", userVol="
    ...
    invoke-virtual {v9}, Landroid/os/storage/StorageVolume;->getOwner()Landroid/os/UserHandle;
    ...
    .line 3895
    .local v8, "tryCount":I
    const-string/jumbo v7, "debug.mtklog.netlog.Running"

    .line 3896
    .local v7, "netlog":Ljava/lang/String;
    const-string/jumbo v6, "debug.mdlogger.Running"

    .line 3897
    .local v6, "mdlogger":Ljava/lang/String;
    const-string/jumbo v1, "debug.MB.running"

    .line 3898
    .local v1, "MBlog":Ljava/lang/String;
    const-string/jumbo v0, "debug.gpsdbglog.enable"

    .line 3899
    .local v0, "GPSlog":Ljava/lang/String;
    :goto_1
    const-string/jumbo v11, "debug.mtklog.netlog.Running"
    ...
    .line 3900
    const-string/jumbo v11, "debug.mdlogger.Running"
    ...
    .line 3901
    const-string/jumbo v11, "debug.MB.running"
    ...
    .line 3902
    const-string/jumbo v11, "debug.gpsdbglog.enable"
    ...
    const-string/jumbo v12, "waitMtkLogStopped done"
    ...
    const-string/jumbo v12, "try count = 60, break"
    ...
    const-string/jumbo v13, "debug.mtklog.netlog.Running="
    ...
    const-string/jumbo v13, "debug.mdlogger.Running="
    ...
    const-string/jumbo v13, "debug.MB.running="
    ...
    const-string/jumbo v13, "debug.gpsdbglog.enable="
...
.method public encryptStorage(ILjava/lang/String;)I
    ...
    .line 2731
    invoke-direct {p0}, Lcom/android/server/MountService;->waitMtkLogStopped()V
...
.method public shutdown(Landroid/os/storage/IMountShutdownObserver;)V
    ...
    .line 1753
    invoke-direct {p0}, Lcom/android/server/MountService;->waitMTKNetlogStopped()V
