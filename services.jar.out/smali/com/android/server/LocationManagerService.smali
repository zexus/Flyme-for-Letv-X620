...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/server/LocationManagerService$MSiPhoneStateListener;,
...
.field private static final SIM_DEFAULT_DATA_CHANGED:Ljava/lang/String; = "android.intent.action.ACTION_DEFAULT_DATA_SUBSCRIPTION_CHANGED"
...
.method static synthetic -wrap11(Lcom/android/server/LocationManagerService;Z)V
    .locals 0
...
.method static synthetic -wrap13(Lcom/android/server/LocationManagerService;Lcom/android/server/LocationManagerService$Receiver;)V
    .locals 0
...
.method static synthetic -wrap14(Lcom/android/server/LocationManagerService;I)V
    .locals 0
    .param p1, "userId"    # I
...
.method static synthetic -wrap15(Lcom/android/server/LocationManagerService;)V
    .locals 0
...
.method static synthetic -wrap16(Lcom/android/server/LocationManagerService;)V
    .locals 0
...
.method static synthetic -wrap4(Lcom/android/server/LocationManagerService;Landroid/content/Intent;)V
    .locals 0
    .param p1, "intent"    # Landroid/content/Intent;

    .prologue
    invoke-direct {p0, p1}, Lcom/android/server/LocationManagerService;->doCampedNetworkStateChanged(Landroid/content/Intent;)V
...
.method static synthetic -wrap5(Lcom/android/server/LocationManagerService;)V
    ...
    invoke-direct {p0}, Lcom/android/server/LocationManagerService;->doPhoneStateChanged()V

    return-void
.end method

.method static synthetic -wrap6(Lcom/android/server/LocationManagerService;Landroid/content/Intent;)V
    .locals 0
    .param p1, "intent"    # Landroid/content/Intent;

    .prologue
    invoke-direct {p0, p1}, Lcom/android/server/LocationManagerService;->doSimStateChanged(Landroid/content/Intent;)V
...
.method static synthetic -wrap7(Lcom/android/server/LocationManagerService;)V
    ...
    invoke-direct {p0}, Lcom/android/server/LocationManagerService;->findNetworkProviderWhenAutoMode()V
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v1, p0, Lcom/android/server/LocationManagerService;->mModeObserver:Lcom/android/server/LocationManagerService$NetWorkProviderModeSettingsObserver;
...
.method private doCampedNetworkStateChanged(Landroid/content/Intent;)V
    .locals 6
    .param p1, "intent"    # Landroid/content/Intent;

    .prologue
    .line 515
    const-string/jumbo v3, "operatornumber"
    ...
    const-string/jumbo v5, "doCampedNetworkStateChanged intent="
    ...
    const-string/jumbo v5, " operatornumber="
...
.method private doPhoneStateChanged()V
    .locals 5
    ...
    const-string/jumbo v4, "doPhoneStateChanged sim mcc="
...
.method private doSimStateChanged(Landroid/content/Intent;)V
    .locals 7
    .param p1, "intent"    # Landroid/content/Intent;
    ...
    const-string/jumbo v5, "doSimStateChangedstatus="
    ...
    const-string/jumbo v5, "doSimStateChanged sim mcc="
...
.method private findNetworkProviderWhenAutoMode()V
    .locals 5
    ...
    const-string/jumbo v4, "findNetworkProviderWhenAutoMode sim mcc="
...
.method private initSettingProvider()V
    ...
    .line 602
    const-string/jumbo v5, "network_provider_package"
    ...
    .line 603
    .local v3, "network_provider_packageName":Ljava/lang/String;
    iget-object v4, p0, Lcom/android/server/LocationManagerService;->mContext:Landroid/content/Context;
    ...
    .local v2, "network_provider_mode":Ljava/lang/String;
    if-nez v2, :cond_0
    ...
    const v5, #android:string@config_default_location_provider_mode#t

    invoke-virtual {v4, v5}, Landroid/content/res/Resources;->getString(I)Ljava/lang/String;

    move-result-object v1

    .local v1, "default_network_provider_mode":Ljava/lang/String;
    ...
    const-string v6, "load the default mode="
    ...
    .line 610
    const-string/jumbo v5, "choose_network_provider_mode"
    ...
    .line 613
    .end local v1    # "default_network_provider_mode":Ljava/lang/String;
    :cond_0
    const/4 v0, 0x0

    .line 614
    .local v0, "default_network_provider":Ljava/lang/String;
    if-eqz v2, :cond_1
    ...
    const-string v5, "load default network provider"
    ...
    const v5, #android:string@config_default_location_provider#t

    invoke-virtual {v4, v5}, Landroid/content/res/Resources;->getString(I)Ljava/lang/String;

    move-result-object v0

    .end local v0    # "default_network_provider":Ljava/lang/String;
    :cond_2
    :goto_0
    if-eqz v0, :cond_3
    ...
    const-string v6, "load the default network provider name="
    ...
    .line 642
    :cond_3
    new-instance v4, Lcom/android/server/LocationManagerService$NetWorkProviderModeSettingsObserver;
    ...
    invoke-direct {v4, p0, v5}, Lcom/android/server/LocationManagerService$NetWorkProviderModeSettingsObserver;-><init>(Lcom/android/server/LocationManagerService;Landroid/os/Handler;)V

    iput-object v4, p0, Lcom/android/server/LocationManagerService;->mModeObserver:Lcom/android/server/LocationManagerService$NetWorkProviderModeSettingsObserver;

    .line 643
    iget-object v4, p0, Lcom/android/server/LocationManagerService;->mModeObserver:Lcom/android/server/LocationManagerService$NetWorkProviderModeSettingsObserver;

    invoke-virtual {v4}, Lcom/android/server/LocationManagerService$NetWorkProviderModeSettingsObserver;->observer()V

    .line 600
    return-void

    .line 623
    .restart local v0    # "default_network_provider":Ljava/lang/String;
    :cond_4
    ...
    const-string/jumbo v5, "load baidu network provider"

    invoke-static {v4, v5}, Landroid/util/Slog;->d(Ljava/lang/String;Ljava/lang/String;)I

    .line 627
    const-string/jumbo v0, "com.baidu.map.location"
    ...
    const-string/jumbo v5, "load google network provider"
...
.method private loadProvidersLocked()V
    ...
    const v5, #android:bool@config_enableGeocoderOverlay#t

    const v6, #android:string@config_geocoderProviderPackageName#t
...
.method private locationIPOcreateProvider()V
    ...
    const v2, #android:bool@config_enableGeocoderOverlay#t

    const v3, #android:string@config_geocoderProviderPackageName#t

    const v4, #android:array@config_locationProviderPackageNames#t
...
.method private mayChangeSettingProvider(Ljava/lang/String;)V
    ...
    const-string/jumbo v4, "change the network provider pkgname="
...
.method private reBindNetworkProviderLock(Z)V
    ...
    const-string v2, "Successfully bind package:"
    ...
    const-string v1, "currently there is no NLP provided."
    ...
    const-string v1, "Failed to bind specified package service"
...
.method private requestLocationUpdatesLocked(Landroid/location/LocationRequest;Lcom/android/server/LocationManagerService$Receiver;IILjava/lang/String;)V
    ...
    const-string/jumbo v7, "provider doesn\'t exisit exception"
...
.method public getGpsUpdatePackages()[Ljava/lang/String;
    .locals 8
    ...
    iget-object v5, v5, Lcom/android/server/LocationManagerService$Receiver;->mPackageName:Ljava/lang/String;
...
.method public systemRunning()V
    ...
    iget-object v7, v0, Lcom/android/server/LocationManagerService;->mLock:Ljava/lang/Object;
    ...
    iput-object v1, v0, Lcom/android/server/LocationManagerService;->mPackageManager:Landroid/content/pm/PackageManager;
    ...
    iput-object v1, v0, Lcom/android/server/LocationManagerService;->mPowerManager:Landroid/os/PowerManager;
    ...
    invoke-direct {v1, v0, v2}, Lcom/android/server/LocationManagerService$LocationWorkerHandler;-><init>(Lcom/android/server/LocationManagerService;Landroid/os/Looper;)V

    move-object/from16 v0, p0

    iput-object v1, v0, Lcom/android/server/LocationManagerService;->mLocationHandler:Lcom/android/server/LocationManagerService$LocationWorkerHandler;
    ...
    iput-object v1, v0, Lcom/android/server/LocationManagerService;->mLocationFudger:Lcom/android/server/location/LocationFudger;
    ...
    iput-object v1, v0, Lcom/android/server/LocationManagerService;->mBlacklist:Lcom/android/server/location/LocationBlacklist;
    ...
    iput-object v1, v0, Lcom/android/server/LocationManagerService;->mGeofenceManager:Lcom/android/server/location/GeofenceManager;

    .line 310
    new-instance v15, Lcom/android/server/LocationManagerService$3;

    move-object/from16 v0, p0

    invoke-direct {v15, v0}, Lcom/android/server/LocationManagerService$3;-><init>(Lcom/android/server/LocationManagerService;)V

    .line 320
    .local v15, "callback":Landroid/app/AppOpsManager$OnOpChangedListener;
    move-object/from16 v0, p0

    iget-object v1, v0, Lcom/android/server/LocationManagerService;->mAppOps:Landroid/app/AppOpsManager;

    const/4 v2, 0x0

    const/4 v3, 0x0

    invoke-virtual {v1, v2, v3, v15}, Landroid/app/AppOpsManager;->startWatchingMode(ILjava/lang/String;Landroid/app/AppOpsManager$OnOpChangedListener;)V

    .line 323
    new-instance v19, Lcom/android/server/LocationManagerService$4;

    invoke-direct/range {v19 .. v20}, Lcom/android/server/LocationManagerService$4;-><init>(Lcom/android/server/LocationManagerService;)V

    .line 331
    .local v19, "permissionListener":Landroid/content/pm/PackageManager$OnPermissionsChangedListener;
    move-object/from16 v0, p0

    iget-object v1, v0, Lcom/android/server/LocationManagerService;->mPackageManager:Landroid/content/pm/PackageManager;

    move-object/from16 v0, v19

    invoke-virtual {v1, v0}, Landroid/content/pm/PackageManager;->addOnPermissionsChangeListener(Landroid/content/pm/PackageManager$OnPermissionsChangedListener;)V
    ...
    iput-object v1, v0, Lcom/android/server/LocationManagerService;->telManager:Landroid/telephony/TelephonyManager;

    .line 335
    move-object/from16 v0, p0

    iget-object v1, v0, Lcom/android/server/LocationManagerService;->telManager:Landroid/telephony/TelephonyManager;

    new-instance v2, Lcom/android/server/LocationManagerService$MSiPhoneStateListener;

    const/4 v3, 0x0

    move-object/from16 v0, p0

    invoke-direct {v2, v0, v3}, Lcom/android/server/LocationManagerService$MSiPhoneStateListener;-><init>(Lcom/android/server/LocationManagerService;Lcom/android/server/LocationManagerService$MSiPhoneStateListener;)V
    ...
    iput-object v1, v0, Lcom/android/server/LocationManagerService;->mUserManager:Landroid/os/UserManager;
    ...
    invoke-direct {v2, v0, v3}, Lcom/android/server/LocationManagerService$NetworkStateReceiver;-><init>(Lcom/android/server/LocationManagerService;Lcom/android/server/LocationManagerService$NetworkStateReceiver;)V
    ...
    .line 349
    invoke-direct/range {p0 .. p0}, Lcom/android/server/LocationManagerService;->loadProvidersLocked()V
    ...
    invoke-direct {v3, v0, v5}, Lcom/android/server/LocationManagerService$5;-><init>(Lcom/android/server/LocationManagerService;Landroid/os/Handler;)V
    ...
    iget-object v1, v0, Lcom/android/server/LocationManagerService;->mPackageMonitor:Lcom/android/internal/content/PackageMonitor;
    ...
    new-instance v6, Lcom/android/server/LocationManagerService$6;

    move-object/from16 v0, p0

    invoke-direct {v6, v0}, Lcom/android/server/LocationManagerService$6;-><init>(Lcom/android/server/LocationManagerService;)V
    ...
    .line 389
    const-string/jumbo v11, "android.intent.action.ACTION_BOOT_IPO"

    .line 390
    .local v11, "ACTION_BOOT_IPO":Ljava/lang/String;
    const-string/jumbo v12, "android.intent.action.ACTION_SHUTDOWN_IPO"

    .line 391
    .local v12, "ACTION_SHUTDOWN_IPO":Ljava/lang/String;
    new-instance v16, Landroid/content/IntentFilter;

    invoke-direct/range {v16 .. v16}, Landroid/content/IntentFilter;-><init>()V

    .line 392
    .local v16, "intentIPOFilter":Landroid/content/IntentFilter;
    const-string/jumbo v1, "ro.mtk_ipo_support"
    ...
    invoke-direct {v2, v0}, Lcom/android/server/LocationManagerService$7;-><init>(Lcom/android/server/LocationManagerService;)V
    ...
    .line 412
    :cond_0
    const-string/jumbo v13, "com.mediatek.location.providercheck"

    .line 413
    .local v13, "ALARM_PVDCHECK":Ljava/lang/String;
    new-instance v18, Landroid/content/IntentFilter;

    invoke-direct/range {v18 .. v18}, Landroid/content/IntentFilter;-><init>()V

    .line 414
    .local v18, "intentPvdChkFilter":Landroid/content/IntentFilter;
    ...
    invoke-direct {v2, v0}, Lcom/android/server/LocationManagerService$8;-><init>(Lcom/android/server/LocationManagerService;)V
    ...
    iput-object v1, v0, Lcom/android/server/LocationManagerService;->mAlarmManager:Landroid/app/AlarmManager;
    ...
    const-string/jumbo v3, "com.mediatek.location.providercheck"
    ...
    iput-object v1, v0, Lcom/android/server/LocationManagerService;->mProviderCheckTimeoutIntent:Landroid/app/PendingIntent;

    .line 432
    const-string/jumbo v14, "com.mediatek.lbs.action.NLP_BIND_REQUEST"

    .line 433
    .local v14, "NLP_BIND_REQUEST":Ljava/lang/String;
    new-instance v17, Landroid/content/IntentFilter;

    invoke-direct/range {v17 .. v17}, Landroid/content/IntentFilter;-><init>()V

    .line 434
    .local v17, "intentNlpFilter":Landroid/content/IntentFilter;
    const-string/jumbo v1, "com.mediatek.lbs.action.NLP_BIND_REQUEST"
    ...
    invoke-direct {v2, v0}, Lcom/android/server/LocationManagerService$9;-><init>(Lcom/android/server/LocationManagerService;)V
    ...
    .end local v11    # "ACTION_BOOT_IPO":Ljava/lang/String;
    .end local v12    # "ACTION_SHUTDOWN_IPO":Ljava/lang/String;
    .end local v13    # "ALARM_PVDCHECK":Ljava/lang/String;
    .end local v14    # "NLP_BIND_REQUEST":Ljava/lang/String;
    .end local v15    # "callback":Landroid/app/AppOpsManager$OnOpChangedListener;
    .end local v16    # "intentIPOFilter":Landroid/content/IntentFilter;
    .end local v17    # "intentNlpFilter":Landroid/content/IntentFilter;
    .end local v18    # "intentPvdChkFilter":Landroid/content/IntentFilter;
    .end local v19    # "permissionListener":Landroid/content/pm/PackageManager$OnPermissionsChangedListener;
    :catchall_0
    move-exception v1
