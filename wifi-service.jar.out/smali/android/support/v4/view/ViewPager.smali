...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-boolean v3, v0, Landroid/support/v4/view/ViewPager;->mIsBeingDragged:Z
    ...
    iget v3, v0, Landroid/support/v4/view/ViewPager;->mMaximumVelocity:I
    ...
    iget v3, v0, Landroid/support/v4/view/ViewPager;->mActivePointerId:I
    ...
    iget v12, v14, Landroid/support/v4/view/ViewPager$ItemInfo;->position:I
    ...
    iget v4, v14, Landroid/support/v4/view/ViewPager$ItemInfo;->offset:F

    sub-float/2addr v3, v4

    iget v4, v14, Landroid/support/v4/view/ViewPager$ItemInfo;->widthFactor:F

    div-float v17, v3, v4

    .line 1911
    .local v17, "pageOffset":F
    move-object/from16 v0, p0
    ...
    .line 1914
    const-string/jumbo v5, " in onTouchEvent ACTION_UP"
    ...
    iput-boolean v3, v0, Landroid/support/v4/view/ViewPager;->mIsUnableToDrag:Z
    ...
    iget-object v3, v0, Landroid/support/v4/view/ViewPager;->mVelocityTracker:Landroid/view/VelocityTracker;
    ...
    iput-object v3, v0, Landroid/support/v4/view/ViewPager;->mVelocityTracker:Landroid/view/VelocityTracker;
    ...
    iget v3, v0, Landroid/support/v4/view/ViewPager;->mInitialMotionX:F
    ...
    invoke-direct {v0, v12, v1, v15, v2}, Landroid/support/v4/view/ViewPager;->determineTargetPage(IFII)I
    ...
    invoke-virtual {v0, v1, v3, v4, v15}, Landroid/support/v4/view/ViewPager;->setCurrentItemInternal(IZZI)V
    ...
    iget-object v4, v0, Landroid/support/v4/view/ViewPager;->mRightEdge:Landroid/support/v4/widget/EdgeEffectCompat;
    ...
    iget-boolean v3, v0, Landroid/support/v4/view/ViewPager;->mIsUnableToDrag:Z
    ...
    iget v10, v0, Landroid/support/v4/view/ViewPager;->mActivePointerId:I

    .line 1967
    .local v10, "activePointerId":I
    const/4 v3, -0x1
    ...
    .line 1976
    const-string/jumbo v5, " in onInterceptTouchEvent ACTION_MOVE"
    ...
    iget v3, v0, Landroid/support/v4/view/ViewPager;->mInitialMotionY:F
    ...
    invoke-direct {v0, v3, v13}, Landroid/support/v4/view/ViewPager;->isGutterDrag(FF)Z
    ...
    iget v3, v0, Landroid/support/v4/view/ViewPager;->mTouchSlopAdjust:I
    ...
    iget-object v3, v0, Landroid/support/v4/view/ViewPager;->mSpecRect:Landroid/graphics/Rect;

    move-object/from16 v0, p0

    move-object/from16 v1, p1

    invoke-direct {v0, v1, v3}, Landroid/support/v4/view/ViewPager;->pointInRect(Landroid/view/MotionEvent;Landroid/graphics/Rect;)Z
    ...
    .line 2000
    const-string/jumbo v5, ", mTouchSlopAdj = "
    ...
    iget v5, v0, Landroid/support/v4/view/ViewPager;->mTouchSlopAdjust:I
    ...
    invoke-virtual/range {v3 .. v8}, Landroid/support/v4/view/ViewPager;->canScroll(Landroid/view/View;ZIII)Z
    ...
    iget v3, v0, Landroid/support/v4/view/ViewPager;->mTouchSlop:I
    ...
    iget v4, v0, Landroid/support/v4/view/ViewPager;->mTouchSlop:I
    ...
    .line 2034
    .end local v10    # "activePointerId":I
    .end local v13    # "dx":F
    ...
    iput v3, v0, Landroid/support/v4/view/ViewPager;->mInitialMotionX:F
    ...
    iput v3, v0, Landroid/support/v4/view/ViewPager;->mInitialMotionY:F

    move-object/from16 v0, p0

    iput v3, v0, Landroid/support/v4/view/ViewPager;->mLastMotionY:F
    ...
    iget v3, v0, Landroid/support/v4/view/ViewPager;->mScrollState:I
    ...
    iget v4, v0, Landroid/support/v4/view/ViewPager;->mCloseEnough:I
    ...
    invoke-direct {v0, v3}, Landroid/support/v4/view/ViewPager;->completeScroll(Z)V
