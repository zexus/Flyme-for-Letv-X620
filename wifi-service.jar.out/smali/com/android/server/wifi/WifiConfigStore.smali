...
.method constructor <init>(Landroid/content/Context;Lcom/android/server/wifi/WifiStateMachine;Lcom/android/server/wifi/WifiNative;)V
    ...
    .line 379
    iput v7, p0, Lcom/android/server/wifi/WifiConfigStore;->maxAuthErrorsToBlacklist:I

    .line 380
    iput v7, p0, Lcom/android/server/wifi/WifiConfigStore;->maxConnectionErrorsToBlacklist:I
...
.method disableNetwork(II)Z
    ...
    .line 1720
    const-string/jumbo v3, "config.autoJoinStatus = WifiConfiguration.AUTO_JOIN_DISABLED_USER_ACTION"
...
.method handleSSIDStateChange(IZLjava/lang/String;Ljava/lang/String;)V
    ...
    .line 4486
    const-string/jumbo v5, " lastConnected: "
    ...
    .line 4521
    iget v4, v1, Landroid/net/wifi/WifiConfiguration;->disableReason:I
    ...
    .line 4522
    const-string/jumbo v4, "User forget network"
    ...
    .line 4528
    const-string/jumbo v4, "Authentication failure, WRONG_KEY"
    ...
    const-string/jumbo v5, "Authentication failure, WRONG_KEY "
...
.method loadConfiguredNetworks()V
    ...
    .line 1893
    .local v15, "mOldConfiguredNetworks":Ljava/util/HashMap;, "Ljava/util/HashMap<Ljava/lang/Integer;Landroid/net/wifi/WifiConfiguration;>;"
    move-object/from16 v0, p0
    ...
    invoke-virtual/range {v19 .. v19}, Lcom/android/server/wifi/ConfigurationMap;->values()Ljava/util/Collection;
    ...
    invoke-virtual/range {v19 .. v19}, Lcom/android/server/wifi/ConfigurationMap;->clear()V
    ...
    invoke-virtual {v0, v12}, Lcom/android/server/wifi/WifiNative;->listNetworks(I)Ljava/lang/String;
    ...
    .line 1911
    const-string/jumbo v19, "WifiConfigStore: loadConfiguredNetworks:  "
    ...
    const-string/jumbo v20, "SSID invalid:"
    ...
    const-string/jumbo v20, "Failed to read network-id \'"
    ...
    const-string/jumbo v20, "[CURRENT]"
    ...
    const-string/jumbo v20, " got CRC for SSID "
    ...
    const-string/jumbo v20, ", was deleted"
    ...
    .line 1961
    const-string/jumbo v19, "Error: get a config with SSID null"
    ...
    .line 1974
    .local v17, "oldConfig":Landroid/net/wifi/WifiConfiguration;
    if-eqz v17, :cond_b
    ...
    iput-wide v0, v4, Landroid/net/wifi/WifiConfiguration;->lastConnected:J
    ...
    const-string/jumbo v20, "WifiConfigStore: loadConfiguredNetworks: check autojoinstatus nid = "
    ...
    .line 1981
    const-string/jumbo v20, " autoJoinStatus="
    ...
    .line 1982
    iget-wide v0, v4, Landroid/net/wifi/WifiConfiguration;->lastConnected:J
    ...
    invoke-virtual/range {v19 .. v20}, Lcom/android/server/wifi/ConfigurationMap;->getByConfigKey(Ljava/lang/String;)Landroid/net/wifi/WifiConfiguration;
    ...
    const-string/jumbo v19, "discarded duplicate network "
    ...
    const-string/jumbo v20, "discarded duplicate network orig nid="
    ...
    const-string/jumbo v19, "loaded configured network"
    ...
    const-string/jumbo v20, "Ignoring loaded configured for network "
    ...
    .line 1995
    const-string/jumbo v20, " because config are not valid"
    ...
    .end local v4    # "config":Landroid/net/wifi/WifiConfiguration;
    .end local v6    # "csum":Ljava/util/zip/Checksum;
    .end local v17    # "oldConfig":Landroid/net/wifi/WifiConfiguration;
    ...
    .end local v14    # "listStr":Ljava/lang/String;
    :cond_11
    ...
    const-string/jumbo v20, "loadConfiguredNetworks loaded "
    ...
    invoke-virtual/range {v20 .. v20}, Lcom/android/server/wifi/ConfigurationMap;->size()I
    ...
    const-string/jumbo v20, " networks"
    ...
    invoke-virtual/range {v19 .. v19}, Lcom/android/server/wifi/ConfigurationMap;->isEmpty()Z
    ...
    .line 2016
    const-string/jumbo v19, "/data/misc/wifi/wpa_supplicant.conf"
    ...
    .line 2017
    const-string/jumbo v19, "/data/misc/wifi/wpa_supplicant.conf.tmp"
    ...
    .line 2018
    sget-object v19, Lcom/android/server/wifi/WifiConfigStore;->networkHistoryConfigFile:Ljava/lang/String;
