...
.method static synthetic -get1()Ljava/text/Collator;
    .locals 1
...
.method static synthetic -set0(Ljava/text/Collator;)Ljava/text/Collator;
    .locals 0
...
.method public static getAllAssetLocales(Landroid/content/Context;Z)Ljava/util/List;
    ...
    .prologue
    .line 102
    sget-boolean v11, Lcom/android/internal/app/LocalePicker;->hasSetCollator:Z
    ...
    sput-boolean v11, Lcom/android/internal/app/LocalePicker;->hasSetCollator:Z
    ...
    const-string/jumbo v12, "settings.locales_order_by_china"
    ...
    invoke-static {v11}, Ljava/text/Collator;->getInstance(Ljava/util/Locale;)Ljava/text/Collator;

    move-result-object v11

    sput-object v11, Lcom/android/internal/app/LocalePicker;->sCollator:Ljava/text/Collator;
    ...
    .end local v3    # "locale$iterator":Ljava/util/Iterator;
    .end local v4    # "localeInfos":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/android/internal/app/LocalePicker$LocaleInfo;>;"
    ...
    .restart local v3    # "locale$iterator":Ljava/util/Iterator;
    .restart local v4    # "localeInfos":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/android/internal/app/LocalePicker$LocaleInfo;>;"
    .restart local v5    # "localeList":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    .restart local v6    # "locales":[Ljava/lang/String;
