...
.method public constructor <init>(Landroid/content/Context;Landroid/view/Display;)V
    ...
    invoke-virtual {p0, v7, v0}, Landroid/view/ViewRootImpl;->enableLog(ZLjava/lang/String;)V
...
.method private performTraversals()V
    ...
    .line 1540
    .local v78, "windowSizeMayChange":Z
    const/16 v57, 0x0
    ...
    .end local v78    # "windowSizeMayChange":Z
    :cond_d
    ...
    .line 1724
    invoke-static/range {v65 .. v65}, Ljava/lang/Integer;->toHexString(I)Ljava/lang/String;
    ...
    .end local v69    # "surfaceChanged":Z
    ...
    .restart local v69    # "surfaceChanged":Z
    .restart local v72    # "viewVisibility":I
    .restart local v78    # "windowSizeMayChange":Z
    :cond_14
    const/16 v73, 0x1
    ...
    .line 1591
    .local v60, "packageMetrics":Landroid/util/DisplayMetrics;
    ...
    .end local v8    # "desiredWindowWidth":I
    .end local v9    # "desiredWindowHeight":I
    .end local v60    # "packageMetrics":Landroid/util/DisplayMetrics;
    :cond_17
    ...
    .line 1698
    .restart local v60    # "packageMetrics":Landroid/util/DisplayMetrics;
    move-object/from16 v0, v60
    ...
    .line 1801
    .local v77, "windowShouldResize":Z
    :goto_9
    move-object/from16 v0, p0
    ...
    .end local v77    # "windowShouldResize":Z
    :cond_4f
    const/4 v4, 0x0
    ...
    .restart local v77    # "windowShouldResize":Z
    goto/16 :goto_9
    ...
    .line 2151
    .local v44, "hardwareRenderer":Landroid/view/HardwareRenderer;
    if-eqz v44, :cond_6b

    invoke-virtual/range {v44 .. v44}, Landroid/view/HardwareRenderer;->isEnabled()Z
    ...
    invoke-virtual/range {v44 .. v44}, Landroid/view/HardwareRenderer;->getWidth()I
    ...
    .end local v41    # "hadSurface":Z
    .end local v44    # "hardwareRenderer":Landroid/view/HardwareRenderer;
    ...
    .line 2317
    .local v32, "content":Landroid/view/View;
    ...
    .line 2320
    .end local v32    # "content":Landroid/view/View;
    :cond_80
    new-instance v4, Ljava/lang/StringBuilder;
    ...
    .line 2402
    .local v34, "curBlurView":Landroid/view/View;
    if-eqz v34, :cond_8a

    .line 2403
    invoke-virtual/range {v34 .. v34}, Landroid/view/View;->getBlurParams()Landroid/graphics/BlurParams;

    move-result-object v35

    .line 2404
    .local v35, "curBp":Landroid/graphics/BlurParams;
    const/16 v45, 0x0
    ...
    .line 2416
    invoke-virtual/range {v34 .. v34}, Landroid/view/View;->getBlurAlpha()F

    move-result v23

    .line 2417
    .local v23, "blurAlpha":F
    move/from16 v0, v23
    ...
    invoke-virtual/range {v35 .. v35}, Landroid/graphics/BlurParams;->isEmpty()Z
    ...
    .line 2435
    .end local v35    # "curBp":Landroid/graphics/BlurParams;
    :cond_89
    if-eqz v56, :cond_8a
    ...
    .line 2452
    .end local v34    # "curBlurView":Landroid/view/View;
    .end local v45    # "hasBlur":Z
    .end local v56    # "needSetBlur":Z
    :cond_8a
    :goto_27
    const/4 v4, 0x0
    ...
    .line 2511
    .local v42, "frameCount":J
    const-string/jumbo v64, "0x0"

    .line 2512
    .local v64, "rendererAddr":Ljava/lang/String;
    move-object/from16 v0, p0
    ...
    .line 2522
    .end local v42    # "frameCount":J
    .end local v64    # "rendererAddr":Ljava/lang/String;
    :cond_92
    const/4 v4, 0x0
    ...
    .line 2154
    .end local v26    # "callbacks":[Landroid/view/SurfaceHolder$Callback;
    .restart local v44    # "hardwareRenderer":Landroid/view/HardwareRenderer;
    :cond_95
    move-object/from16 v0, p0

    iget v4, v0, Landroid/view/ViewRootImpl;->mHeight:I

    invoke-virtual/range {v44 .. v44}, Landroid/view/HardwareRenderer;->getHeight()I
    ...
    .line 2229
    .end local v76    # "windowMoved":Z
    :cond_9a
    const/16 v76, 0x1

    .restart local v76    # "windowMoved":Z
    goto :goto_2c
    ...
    .local v24, "blurVisibilityChanged":Z
    goto/16 :goto_23

    .line 2422
    .end local v24    # "blurVisibilityChanged":Z
    .restart local v23    # "blurAlpha":F
    .restart local v34    # "curBlurView":Landroid/view/View;
    .local v35, "curBp":Landroid/graphics/BlurParams;
    .restart local v45    # "hasBlur":Z
    .restart local v56    # "needSetBlur":Z
    .restart local v62    # "pos":[I
    :cond_a7
    const/16 v45, 0x1
...
.method public enableLog(ZLjava/lang/String;)V
    ...
    const-string/jumbo v6, "enableLog: enable = "
