...
.method constructor <init>(Lcom/android/internal/view/IInputMethodManager;Landroid/os/Looper;)V
    ...
    const-string/jumbo v3, "imm.debug"
...
.method private checkFocusNoStartInput(ZZ)Z
    ...
    const-string/jumbo v4, "checkFocus: view="
    ...
    .line 1432
    const-string/jumbo v4, " forceNewFocus="
...
.method clearBindingLocked()V
    ...
    const-string/jumbo v1, "Clearing binding!"
...
.method doDump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    .line 2247
    const-string/jumbo v1, "InputMethodManager DEBUG is turn on!"
    ...
    .line 2253
    const-string/jumbo v1, "InputMethodManager DEBUG is turn off!"
...
.method finishInputLocked()V
    ...
    const-string/jumbo v3, "FINISH INPUT: "
...
.method public focusOut(Landroid/view/View;)V
    ...
    const-string/jumbo v3, "focusOut: "
    ...
    .line 1372
    const-string/jumbo v3, " winFocus="
...
.method public hideSoftInputFromInputMethod(Landroid/os/IBinder;I)V
    ...
    const-string/jumbo v2, "InputMethod request hide itself"
...
.method public hideSoftInputFromWindow(Landroid/os/IBinder;ILandroid/os/ResultReceiver;)Z
    ...
    const-string/jumbo v2, "ap request hide soft input"
    ...
    const-string/jumbo v3, "Soft input will be hidden"
...
.method public isSoftInputShown()Z
    ...
    invoke-interface {v2}, Lcom/android/internal/view/IInputMethodManager;->isSoftInputShown()Z
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public notifyUserAction()V
    ...
    const-string/jumbo v4, "Ignoring notifyUserAction as it has already been sent. mLastSentUserActionNotificationSequenceNumber: "
    ...
    .line 2069
    const-string/jumbo v4, " mNextUserActionNotificationSequenceNumber: "
...
.method public onPostWindowFocus(Landroid/view/View;Landroid/view/View;IZI)V
    ...
    const-string/jumbo v5, "onWindowFocus: "
    ...
    const-string/jumbo v3, "Has been inactive!  Starting fresh"
    ...
    const-string/jumbo v2, "Reporting focus gain, without startInput"
...
.method public onPreWindowFocus(Landroid/view/View;Z)V
    ...
    const-string/jumbo v3, "Ignoring onPreWindowFocus(). mCurRootView="
...
.method public sendAppPrivateCommand(Landroid/view/View;Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    const-string/jumbo v4, "APP PRIVATE COMMAND "
...
.method public showSoftInput(Landroid/view/View;ILandroid/os/ResultReceiver;)Z
    ...
    const-string/jumbo v2, "ap request show soft input."
    ...
    const-string/jumbo v3, "Soft input will be shown"
...
.method public showSoftInputFromInputMethod(Landroid/os/IBinder;I)V
    ...
    const-string/jumbo v2, "InputMethod request show itself"
...
.method startInputInner(Landroid/os/IBinder;III)Z
    ...
    const-string/jumbo v4, "Starting input: view="
    ...
    const-string/jumbo v3, "ABORT input: no served view!"
    ...
    const-string/jumbo v2, "ABORT input: no handler for view! Close current input."
    ...
    const-string/jumbo v2, "Starting input: reschedule to view thread"
    ...
    const-string/jumbo v3, "Starting input: tba="
    ...
    const-string/jumbo v3, "START INPUT: "
    ...
    .line 1275
    const-string/jumbo v3, " controlFlags=#"
    ...
    const-string/jumbo v3, "Starting input: Bind result="
    ...
    const-string/jumbo v3, "Starting input: finished by someone else (view="
    ...
    const-string/jumbo v2, "ABORT input: no input method!"
...
.method public updateCursor(Landroid/view/View;IIII)V
    ...
    const-string/jumbo v4, "CURSOR CHANGE: "
...
.method public updateCursorAnchorInfo(Landroid/view/View;Landroid/view/inputmethod/CursorAnchorInfo;)V
    ...
    const-string/jumbo v5, "Ignoring redundant updateCursorAnchorInfo: info="
...
.method public updateSelection(Landroid/view/View;IIII)V
    ...
    const-string/jumbo v4, "SELECTION CHANGE: "
