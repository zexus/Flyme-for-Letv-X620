...
.field static final TRANSACTION_setBlur:I = 0x1d
...
.method public onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    check-cast v65, Landroid/graphics/Region;
    ...
    .local v65, "_arg1":Landroid/graphics/Region;
    goto :goto_19

    .line 382
    .end local v4    # "_arg0":Landroid/view/IWindow;
    .end local v65    # "_arg1":Landroid/graphics/Region;
    :sswitch_a
    const-string/jumbo v3, "android.view.IWindowSession"
    ...
    .line 418
    .restart local v4    # "_arg0":Landroid/view/IWindow;
    new-instance v64, Landroid/graphics/Rect;

    invoke-direct/range {v64 .. v64}, Landroid/graphics/Rect;-><init>()V

    .line 419
    .local v64, "_arg1":Landroid/graphics/Rect;
    move-object/from16 v0, p0
    ...
    .line 432
    .end local v4    # "_arg0":Landroid/view/IWindow;
    .end local v64    # "_arg1":Landroid/graphics/Rect;
    :sswitch_c
    const-string/jumbo v3, "android.view.IWindowSession"
    ...
    .line 464
    .end local v68    # "_arg2":Z
    .end local v73    # "_result":Z
    :cond_20
    const/16 v68, 0x0

    .restart local v68    # "_arg2":Z
    goto :goto_20
    ...
    .line 484
    .local v71, "_result":Landroid/os/IBinder;
    invoke-virtual/range {p3 .. p3}, Landroid/os/Parcel;->writeNoException()V
    ...
    .end local v71    # "_result":Landroid/os/IBinder;
    :sswitch_11
    const-string/jumbo v3, "android.view.IWindowSession"
    ...
    .line 528
    .end local v67    # "_arg1":Z
    :cond_25
    const/16 v67, 0x0

    .restart local v67    # "_arg1":Z
    goto :goto_25
    ...
    .line 613
    .local v70, "_result":Landroid/os/Bundle;
    invoke-virtual/range {p3 .. p3}, Landroid/os/Parcel;->writeNoException()V
    ...
    .end local v70    # "_result":Landroid/os/Bundle;
    :cond_26
    const/16 v60, 0x0
    ...
    .line 619
    .restart local v70    # "_result":Landroid/os/Bundle;
    :cond_28
    const/4 v3, 0x0
    ...
    .local v66, "_arg1":Landroid/os/Bundle;
    goto :goto_29

    .line 641
    .end local v52    # "_arg0":Landroid/os/IBinder;
    .end local v66    # "_arg1":Landroid/os/Bundle;
    :sswitch_1a
    const-string/jumbo v3, "android.view.IWindowSession"
    ...
    .line 661
    .local v72, "_result":Landroid/view/IWindowId;
    invoke-virtual/range {p3 .. p3}, Landroid/os/Parcel;->writeNoException()V

    .line 662
    if-eqz v72, :cond_2b

    invoke-interface/range {v72 .. v72}, Landroid/view/IWindowId;->asBinder()Landroid/os/IBinder;
    ...
    .line 667
    .end local v52    # "_arg0":Landroid/os/IBinder;
    .end local v72    # "_result":Landroid/view/IWindowId;
    :sswitch_1c
    const-string/jumbo v3, "android.view.IWindowSession"
    ...
    .line 681
    sget-object v3, Landroid/graphics/BlurParams;->CREATOR:Landroid/os/Parcelable$Creator;
    ...
    check-cast v63, Landroid/graphics/BlurParams;
    ...
    invoke-virtual {v0, v4, v1}, Landroid/view/IWindowSession$Stub;->setBlur(Landroid/view/IWindow;Landroid/graphics/BlurParams;)V
    ...
    .local v63, "_arg1":Landroid/graphics/BlurParams;
    goto :goto_2c
