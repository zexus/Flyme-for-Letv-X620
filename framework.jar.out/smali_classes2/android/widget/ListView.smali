...
.method protected dispatchDraw(Landroid/graphics/Canvas;)V
    ...
    .line 3377
    .local v35, "listAdapter":Landroid/widget/ListAdapter;
    ...
    .end local v35    # "listAdapter":Landroid/widget/ListAdapter;
    :cond_5
    :goto_4
    const/16 v34, 0x0
    ...
    .line 3389
    .local v43, "rightDividerMargin":I
    move-object/from16 v0, p0
    ...
    .end local v36    # "listBottom":I
    .end local v41    # "paint":Landroid/graphics/Paint;
    .end local v43    # "rightDividerMargin":I
    .end local v44    # "scrollY":I
    :cond_9
    const/16 v17, 0x0
    ...
    .restart local v36    # "listBottom":I
    .restart local v43    # "rightDividerMargin":I
    .restart local v44    # "scrollY":I
    :cond_e
    if-eqz v15, :cond_7
    ...
    .line 3438
    :cond_16
    add-int/lit8 v37, v33, 0x1

    .line 3442
    .local v37, "nextIndex":I
    move/from16 v0, v33
    ...
    .line 3519
    .restart local v42    # "previousIndex":I
    :cond_29
    if-eqz v21, :cond_27
...
.method fillGap(Z)V
    ...
    .line 684
    .local v1, "isEnter":Z
    iget-boolean v5, p0, Landroid/widget/ListView;->mLeOverScrollEnable:Z
...
.method protected layoutChildren()V
    ...
    const-string/jumbo v39, "The content of the adapter has changed but ListView did not receive a notification. Make sure the content of your adapter is not modified from a background thread, but only from the UI thread. Make sure your adapter calls notifyDataSetChanged() when its content changes. [in ListView("
    ...
    const-string/jumbo v38, "Abandon active views because it cann\'t be reused!"
    ...
    const-string/jumbo v39, "mSelectorRect.setEmpty in layoutChildren with sel = "
    ...
    const-string/jumbo v39, "mSelectorRect.setEmpty in layoutChildren this="
