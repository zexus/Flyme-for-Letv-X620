...
.method private notifyOnDismissListener()V
    ...
    const-string/jumbo v1, "Callbacks.notifyOnDismissListener"
    ...
    invoke-static {v0}, Landroid/widget/ActivityChooserView;->-get9(Landroid/widget/ActivityChooserView;)Landroid/widget/PopupWindow$OnDismissListener;
...
.method private startActivity(Landroid/content/Intent;Landroid/content/pm/ResolveInfo;)V
    ...
    invoke-static {v3}, Landroid/widget/ActivityChooserView;->-get2(Landroid/widget/ActivityChooserView;)Landroid/content/Context;
...
.method public onClick(Landroid/view/View;)V
    ...
    const-string/jumbo v5, "Callbacks.onClick, view = "
    ...
    invoke-static {v3}, Landroid/widget/ActivityChooserView;->-get1(Landroid/widget/ActivityChooserView;)Landroid/widget/ActivityChooserView$ActivityChooserViewAdapter;
    ...
    invoke-static {v3}, Landroid/widget/ActivityChooserView;->-get4(Landroid/widget/ActivityChooserView;)Landroid/widget/FrameLayout;
    ...
    invoke-static {v3, v6}, Landroid/widget/ActivityChooserView;->-set0(Landroid/widget/ActivityChooserView;Z)Z
    ...
    invoke-static {v4}, Landroid/widget/ActivityChooserView;->-get5(Landroid/widget/ActivityChooserView;)I
...
.method public onDismiss()V
    ...
    const-string/jumbo v1, "Callbacks.onDismiss"
...
.method public onItemClick(Landroid/widget/AdapterView;Landroid/view/View;IJ)V
    ...
    .line 654
    const-string/jumbo v4, "ActivityChooserView"

    const-string/jumbo v5, "Callbacks.onItemClick"
    ...
    invoke-static {v4}, Landroid/widget/ActivityChooserView;->-get7(Landroid/widget/ActivityChooserView;)Z
    ...
    invoke-static {v4}, Landroid/widget/ActivityChooserView;->-get1(Landroid/widget/ActivityChooserView;)Landroid/widget/ActivityChooserView$ActivityChooserViewAdapter;
...
.method public onLongClick(Landroid/view/View;)Z
    ...
    const-string/jumbo v1, "Callbacks.onLongClick"
    ...
    invoke-static {v0}, Landroid/widget/ActivityChooserView;->-get3(Landroid/widget/ActivityChooserView;)Landroid/widget/FrameLayout;
    ...
    invoke-static {v0}, Landroid/widget/ActivityChooserView;->-get10(Landroid/widget/ActivityChooserView;)Z
    ...
    invoke-static {v0, v3}, Landroid/widget/ActivityChooserView;->-set0(Landroid/widget/ActivityChooserView;Z)Z
    ...
    invoke-static {v1}, Landroid/widget/ActivityChooserView;->-get5(Landroid/widget/ActivityChooserView;)I
