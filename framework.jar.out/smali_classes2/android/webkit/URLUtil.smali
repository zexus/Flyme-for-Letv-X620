...
.field private static final CONTENT_DISPOSITION_EXTRA_INLINE_PATTERN:Ljava/util/regex/Pattern;

.field private static final CONTENT_DISPOSITION_EXTRA_PATTERN:Ljava/util/regex/Pattern;
...
.method static constructor <clinit>()V
    ...
    .line 399
    const-string/jumbo v0, "attachment;\\s*filename\\s*=\\s*(\"?)=\\?([a-zA-Z0-9-_]+)\\?B\\?([a-zA-Z0-9+/]*[=]{0,2})(\\?=)\\1\\s*$"
    ...
    .line 405
    const-string/jumbo v0, "attachment;\\s*filename\\s*=\\s*(\"?)([^\"]*)\\1.*$"
    ...
    .line 404
    sput-object v0, Landroid/webkit/URLUtil;->CONTENT_DISPOSITION_EXTRA_PATTERN:Ljava/util/regex/Pattern;

    .line 408
    const-string/jumbo v0, "inline;\\s*filename\\s*=\\s*(\"?)([^\"]*)\\1.*$"
    ...
    .line 407
    sput-object v0, Landroid/webkit/URLUtil;->CONTENT_DISPOSITION_EXTRA_INLINE_PATTERN:Ljava/util/regex/Pattern;
...
.method static parseContentDisposition(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 467
    :try_start_3
    sget-object v7, Landroid/webkit/URLUtil;->CONTENT_DISPOSITION_EXTRA_PATTERN:Ljava/util/regex/Pattern;
    ...
    .line 477
    :try_start_4
    sget-object v7, Landroid/webkit/URLUtil;->CONTENT_DISPOSITION_EXTRA_INLINE_PATTERN:Ljava/util/regex/Pattern;
    ...
    .line 450
    .local v2, "illBase64Ex":Ljava/lang/IllegalStateException;
    const-string/jumbo v7, "webkit"
    ...
    const-string/jumbo v9, "IllegalStateException: illBase64Ex: "
    ...
    .line 443
    .end local v2    # "illBase64Ex":Ljava/lang/IllegalStateException;
    .restart local v4    # "m":Ljava/util/regex/Matcher;
    :catch_2
    move-exception v6
    ...
    const-string/jumbo v9, "IllegalStateException: ex: "
    ...
    const-string/jumbo v9, "Extra IllegalStateException: ex: "
    ...
    const-string/jumbo v9, "Extra inline IllegalStateException: ex: "
...
.method static testParseContentDisposition()V
    ...
    const-string/jumbo v1, "attachment; filename=\"image001.jpg\""
    ...
    .line 499
    const-string/jumbo v1, "attachment; filename=\"=?ISO-8859-1?B?aW1hZ2UwMDEuanBn?=\""
    ...
    .line 502
    const-string/jumbo v1, "attachment; filename=\"=?UTF-8?B?aW1hZ2UwMDEuanBn?=\""
    ...
    .line 505
    const-string/jumbo v1, "attachment; filename=\"=?GB2312?B?JWQ2JWQwJWNlJWM0JWJhJWJhJWQ3JWQ2?=\""
