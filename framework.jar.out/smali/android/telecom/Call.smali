...
.field public static final EXTRA_YP_QUERY_RESULT_KEY:Ljava/lang/String; = "yellowPageQueryResult"

.field public static final STATE_ACTIVE:I = 0x4

.field public static final STATE_ALERTING:I = 0xb
...
.field private mSavedDisplayName:Ljava/lang/String;
...
.method private checkYellowPageInfo()V
    .locals 5

    .prologue
    .line 1192
    iget-object v3, p0, Landroid/telecom/Call;->mDetails:Landroid/telecom/Call$Details;
    ...
    .line 1194
    const-string/jumbo v4, "yellowPageQueryResult"
    ...
    check-cast v1, Lcom/android/internal/telephony/CallerYellowPageInfo;

    .line 1195
    .local v1, "info":Lcom/android/internal/telephony/CallerYellowPageInfo;
    if-eqz v1, :cond_0

    iget-boolean v3, v1, Lcom/android/internal/telephony/CallerYellowPageInfo;->isYellowPageInfoExist:Z

    if-eqz v3, :cond_0

    .line 1196
    iget-object v3, v1, Lcom/android/internal/telephony/CallerYellowPageInfo;->yellowPageName:Ljava/lang/String;
    ...
    iget-object v0, v1, Lcom/android/internal/telephony/CallerYellowPageInfo;->yellowPageTag:Ljava/lang/String;
    ...
    .line 1200
    iget-object v3, p0, Landroid/telecom/Call;->mSavedDisplayName:Ljava/lang/String;
    ...
    .line 1201
    .local v2, "yellowPageInfoChanged":Z
    :goto_1
    if-eqz v2, :cond_0

    iget-object v3, p0, Landroid/telecom/Call;->mCallbackRecords:Ljava/util/List;
    ...
    .line 1202
    iput-object v0, p0, Landroid/telecom/Call;->mSavedDisplayName:Ljava/lang/String;

    .line 1203
    invoke-direct {p0}, Landroid/telecom/Call;->fireYellowPageInfoChanged()V

    .line 1191
    .end local v0    # "displayName":Ljava/lang/String;
    .end local v1    # "info":Lcom/android/internal/telephony/CallerYellowPageInfo;
    .end local v2    # "yellowPageInfoChanged":Z
    :cond_0
    return-void

    .line 1197
    .restart local v1    # "info":Lcom/android/internal/telephony/CallerYellowPageInfo;
    :cond_1
    iget-object v0, v1, Lcom/android/internal/telephony/CallerYellowPageInfo;->yellowPageName:Ljava/lang/String;
    ...
    .restart local v2    # "yellowPageInfoChanged":Z
    goto :goto_1
.end method
...
.method private fireCallDestroyed()V
    ...
    invoke-direct {v5, p0, v1, v0, v2}, Landroid/telecom/Call$9;-><init>(Landroid/telecom/Call;Landroid/telecom/Call$Callback;Landroid/telecom/Call;Landroid/telecom/CallbackRecord;)V
...
.method private fireCannedTextResponsesLoaded(Ljava/util/List;)V
    ...
    invoke-direct {v5, p0, v1, v0, p1}, Landroid/telecom/Call$6;-><init>(Landroid/telecom/Call;Landroid/telecom/Call$Callback;Landroid/telecom/Call;Ljava/util/List;)V
...
.method private fireChildrenChanged(Ljava/util/List;)V
    ...
    invoke-direct {v5, p0, v1, v0, p1}, Landroid/telecom/Call$4;-><init>(Landroid/telecom/Call;Landroid/telecom/Call$Callback;Landroid/telecom/Call;Ljava/util/List;)V
...
.method private fireConferenceableCallsChanged()V
    ...
    new-instance v5, Landroid/telecom/Call$10;

    invoke-direct {v5, p0, v1, v0}, Landroid/telecom/Call$10;-><init>(Landroid/telecom/Call;Landroid/telecom/Call$Callback;Landroid/telecom/Call;)V
...
.method private fireDetailsChanged(Landroid/telecom/Call$Details;)V
    ...
    invoke-direct {v5, p0, v1, v0, p1}, Landroid/telecom/Call$5;-><init>(Landroid/telecom/Call;Landroid/telecom/Call$Callback;Landroid/telecom/Call;Landroid/telecom/Call$Details;)V
...
.method private fireParentChanged(Landroid/telecom/Call;)V
    ...
    invoke-direct {v5, p0, v1, v0, p1}, Landroid/telecom/Call$3;-><init>(Landroid/telecom/Call;Landroid/telecom/Call$Callback;Landroid/telecom/Call;Landroid/telecom/Call;)V
...
.method private firePostDialWait(Ljava/lang/String;)V
    ...
    invoke-direct {v5, p0, v1, v0, p1}, Landroid/telecom/Call$8;-><init>(Landroid/telecom/Call;Landroid/telecom/Call$Callback;Landroid/telecom/Call;Ljava/lang/String;)V
...
.method private fireStateChanged(I)V
    ...
    invoke-direct {v5, p0, v1, v0, p1}, Landroid/telecom/Call$2;-><init>(Landroid/telecom/Call;Landroid/telecom/Call$Callback;Landroid/telecom/Call;I)V
...
.method private fireVideoCallChanged(Landroid/telecom/InCallService$VideoCall;)V
    ...
    invoke-direct {v5, p0, v1, v0, p1}, Landroid/telecom/Call$7;-><init>(Landroid/telecom/Call;Landroid/telecom/Call$Callback;Landroid/telecom/Call;Landroid/telecom/InCallService$VideoCall;)V
...
.method private fireYellowPageInfoChanged()V
    .locals 6
    ...
    invoke-direct {v5, p0, v1, v0}, Landroid/telecom/Call$1;-><init>(Landroid/telecom/Call;Landroid/telecom/Call$Callback;Landroid/telecom/Call;)V
...
.method final internalUpdate(Landroid/telecom/ParcelableCall;Ljava/util/Map;)V
    ...
    .line 1110
    :cond_0
    invoke-direct/range {p0 .. p0}, Landroid/telecom/Call;->checkYellowPageInfo()V
