...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Landroid/app/ApplicationPackageManager$InstallPackageObserver;,
        Landroid/app/ApplicationPackageManager$DeletePackageObserver;,
...
# direct methods
.method static synthetic -get0(Landroid/app/ApplicationPackageManager;)Landroid/app/ContextImpl;
    .locals 1
...
.method private getUserIfProfile(I)Landroid/content/pm/UserInfo;
    ...
    const-string/jumbo v4, "getProfiles userProfiles is null ."
...
.method public authentificationFeatureMap(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-interface {v1, p1, p2, p3}, Landroid/content/pm/IPackageManager;->authentificationFeatureMap(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Z
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public deletePackageSlient(Ljava/lang/String;I)V
    .locals 2
    .param p1, "PackageName"    # Ljava/lang/String;
    .param p2, "flags"    # I
    ...
    .line 2504
    new-instance v0, Landroid/app/ApplicationPackageManager$DeletePackageObserver;

    invoke-direct {v0, p0, v1}, Landroid/app/ApplicationPackageManager$DeletePackageObserver;-><init>(Landroid/app/ApplicationPackageManager;Landroid/app/ApplicationPackageManager$DeletePackageObserver;)V

    .line 2505
    .local v0, "deletePackageObserver":Landroid/app/ApplicationPackageManager$DeletePackageObserver;
    if-eqz p1, :cond_0

    .line 2506
    invoke-virtual {v0, p1}, Landroid/app/ApplicationPackageManager$DeletePackageObserver;->setPackageName(Ljava/lang/String;)V

    .line 2508
    :cond_0
    invoke-virtual {p0, p1, v0, p2}, Landroid/app/ApplicationPackageManager;->deletePackage(Ljava/lang/String;Landroid/content/pm/IPackageDeleteObserver;I)V
...
.method public getCloneResolveInfo(Landroid/content/pm/ResolveInfo;)Landroid/content/pm/ResolveInfo;
    ...
    invoke-interface {v1, p1}, Landroid/content/pm/IPackageManager;->getCloneResolveInfo(Landroid/content/pm/ResolveInfo;)Landroid/content/pm/ResolveInfo;
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public getDefaultActivityIcon()Landroid/graphics/drawable/Drawable;
    ...
    const v1, #android:drawable@default_icon#t
...
.method public getFeatureMap(Ljava/lang/String;Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-interface {v2, p1, p2}, Landroid/content/pm/IPackageManager;->getFeatureMap(Ljava/lang/String;Ljava/lang/String;)Ljava/util/List;
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    .line 2541
    .restart local v1    # "featureList":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    :catch_0
    move-exception v0
...
.method public getResourcesForApplication(Landroid/content/pm/ApplicationInfo;)Landroid/content/res/Resources;
    ...
    .line 1061
    new-instance v9, Landroid/content/res/theme/LeResourceHelper;

    invoke-direct {v9, v8}, Landroid/content/res/theme/LeResourceHelper;-><init>(Landroid/content/res/Resources;)V

    .line 1062
    .local v9, "resHelper":Landroid/content/res/theme/LeResourceHelper;
    iget v0, p1, Landroid/content/pm/ApplicationInfo;->icon:I

    iget-object v1, p1, Landroid/content/pm/ApplicationInfo;->packageName:Ljava/lang/String;

    invoke-virtual {v9, v0, v1}, Landroid/content/res/theme/LeResourceHelper;->setPackageIconId(ILjava/lang/String;)V

    .line 1063
    iget v0, p1, Landroid/content/pm/ApplicationInfo;->labelRes:I

    invoke-virtual {v9, v0}, Landroid/content/res/theme/LeResourceHelper;->setPackageLabelId(I)V

    .line 1064
    invoke-virtual {v8, v9}, Landroid/content/res/Resources;->setHelper(Landroid/content/res/theme/LeResourceHelper;)V

    .line 1067
    .end local v9    # "resHelper":Landroid/content/res/theme/LeResourceHelper;
    :cond_1
    if-eqz v8, :cond_5
...
.method public installPackageSlient(Landroid/net/Uri;ILjava/lang/String;Ljava/lang/String;)V
    .locals 2
    .param p1, "packageURI"    # Landroid/net/Uri;
    .param p2, "flags"    # I
    .param p3, "PackageName"    # Ljava/lang/String;
    ...
    .line 2374
    new-instance v0, Landroid/app/ApplicationPackageManager$InstallPackageObserver;

    invoke-direct {v0, p0, v1}, Landroid/app/ApplicationPackageManager$InstallPackageObserver;-><init>(Landroid/app/ApplicationPackageManager;Landroid/app/ApplicationPackageManager$InstallPackageObserver;)V

    .line 2375
    .local v0, "packageInstallObserver":Landroid/app/ApplicationPackageManager$InstallPackageObserver;
    if-eqz p3, :cond_0

    .line 2376
    invoke-virtual {v0, p3}, Landroid/app/ApplicationPackageManager$InstallPackageObserver;->setPackageName(Ljava/lang/String;)V

    .line 2377
    invoke-virtual {v0, p3}, Landroid/app/ApplicationPackageManager$InstallPackageObserver;->getNew(Ljava/lang/String;)V

    .line 2379
    invoke-virtual {v0, p2}, Landroid/app/ApplicationPackageManager$InstallPackageObserver;->setFlags(I)V

    .line 2382
    :cond_0
    invoke-virtual {p0, p1, v0, p2, p4}, Landroid/app/ApplicationPackageManager;->installPackage(Landroid/net/Uri;Landroid/app/PackageInstallObserver;ILjava/lang/String;)V
...
.method public isAppDouble(Ljava/lang/String;)Z
    ...
    invoke-interface {v1, p1}, Landroid/content/pm/IPackageManager;->isAppDouble(Ljava/lang/String;)Z
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public loadUnbadgedItemIcon(Landroid/content/pm/PackageItemInfo;Landroid/content/pm/ApplicationInfo;)Landroid/graphics/drawable/Drawable;
    ...
    instance-of v8, p1, Landroid/content/pm/ApplicationInfo;
    ...
    const-string/jumbo v9, "getDrawable create calendar icon calendar"
    ...
    .line 2149
    .local v6, "rs":Landroid/content/res/Resources;
    ...
    .line 2150
    .local v5, "ledr":Landroid/graphics/drawable/Drawable;
    const-string/jumbo v8, "ApplicationPackageManager"

    const-string/jumbo v9, "getDrawable LeIconCustomHelper create calendar icon"
    ...
    const-string/jumbo v9, "getDrawable BitmapDrawable create calendar icon is error"

    invoke-static {v8, v9}, Landroid/util/Log;->i(Ljava/lang/String;Ljava/lang/String;)I

    .line 2163
    .end local v0    # "bitmap":Landroid/graphics/Bitmap;
    .end local v5    # "ledr":Landroid/graphics/drawable/Drawable;
    .end local v6    # "rs":Landroid/content/res/Resources;
    :cond_1
    ...
    iget v9, p1, Landroid/content/pm/PackageItemInfo;->icon:I

    invoke-virtual {p0, v8, v9, p2}, Landroid/app/ApplicationPackageManager;->getDrawable(Ljava/lang/String;ILandroid/content/pm/ApplicationInfo;)Landroid/graphics/drawable/Drawable;
    ...
    .line 2180
    :try_start_0
    const-string/jumbo v7, "com.android.captiveportallogin"

    .line 2181
    .local v7, "wlanIcon":Ljava/lang/String;
    if-eqz p1, :cond_5
    ...
    const-string/jumbo v9, "getDrawable create wlan icon"
    ...
    invoke-static {v8, v7}, Landroid/content/res/theme/LeIconCustomHelper;->getCurrentPackageIcon(Landroid/content/Context;Ljava/lang/String;)Landroid/graphics/Bitmap;
    ...
    .line 2187
    .restart local v6    # "rs":Landroid/content/res/Resources;
    ...
    const-string/jumbo v9, "getDrawable LeIconCustomHelper create wlan icon"
    ...
    .line 2205
    .end local v7    # "wlanIcon":Ljava/lang/String;
    :cond_4
    :goto_2
    return-object v1
    ...
    .restart local v7    # "wlanIcon":Ljava/lang/String;
    :cond_5
    move-object v1, v2
    ...
    const-string/jumbo v9, "getDrawable LeIconCustomHelper no wlan icon"
    ...
    const-string/jumbo v10, "getDrawable LeIconCustomHelper icon Exception"
...
.method public queryDefaultPreferredActivity(Landroid/content/Intent;I)Landroid/content/pm/ResolveInfo;
    .locals 5
    .param p1, "intent"    # Landroid/content/Intent;
    .param p2, "flags"    # I
    ...
    .line 2565
    invoke-interface {v2, p1, v3, p2, v4}, Landroid/content/pm/IPackageManager;->queryDefaultPreferredActivity(Landroid/content/Intent;Ljava/lang/String;II)Landroid/content/pm/ResolveInfo;
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string/jumbo v3, "queryDefaultPreferredActivity RemoteException"
...
.method public recoverySystemInstallPackage(Ljava/lang/String;)V
    ...
    invoke-interface {v1, p1}, Landroid/content/pm/IPackageManager;->recoverySystemInstallPackage(Ljava/lang/String;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public setPermByList(Ljava/lang/String;Z)Z
    ...
    invoke-interface {v2, p1, p2}, Landroid/content/pm/IPackageManager;->setPermByList(Ljava/lang/String;Z)Z
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string/jumbo v3, "getPermission : App : setPermByList RemoteException"
