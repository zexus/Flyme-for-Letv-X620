...
.field private static sWebUrlPattern:Ljava/util/regex/Pattern;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/util/Patterns;->sWebUrlPattern:Ljava/util/regex/Pattern;
...
.method public static final getWebUrlPattern()Ljava/util/regex/Pattern;
    .locals 6

    .prologue
    .line 177
    sget-object v4, Landroid/util/Patterns;->sWebUrlPattern:Ljava/util/regex/Pattern;

    if-nez v4, :cond_0

    .line 179
    const-class v4, Lcom/mediatek/common/util/IWebProtocolNames;
    ...
    .line 178
    invoke-static {v4}, Lcom/mediatek/common/MPlugin;->createInstance(Ljava/lang/String;)Ljava/lang/Object;

    move-result-object v2

    check-cast v2, Lcom/mediatek/common/util/IWebProtocolNames;

    .line 180
    .local v2, "plugin":Lcom/mediatek/common/util/IWebProtocolNames;
    if-eqz v2, :cond_3

    .line 181
    invoke-interface {v2}, Lcom/mediatek/common/util/IWebProtocolNames;->getExtendedWebUrlProtocol()Ljava/lang/String;

    move-result-object v1

    .line 182
    .local v1, "newProtocolsStr":Ljava/lang/String;
    if-nez v1, :cond_1

    .line 183
    sget-object v4, Landroid/util/Patterns;->WEB_URL:Ljava/util/regex/Pattern;

    sput-object v4, Landroid/util/Patterns;->sWebUrlPattern:Ljava/util/regex/Pattern;

    .line 200
    .end local v1    # "newProtocolsStr":Ljava/lang/String;
    :cond_0
    :goto_0
    sget-object v4, Landroid/util/Patterns;->sWebUrlPattern:Ljava/util/regex/Pattern;
    ...
    .line 185
    .restart local v1    # "newProtocolsStr":Ljava/lang/String;
    :cond_1
    sget-object v4, Landroid/util/Patterns;->WEB_URL:Ljava/util/regex/Pattern;
    ...
    .line 186
    .local v3, "webUrlStr":Ljava/lang/String;
    ...
    .end local v1    # "newProtocolsStr":Ljava/lang/String;
    .end local v3    # "webUrlStr":Ljava/lang/String;
    :cond_3
    const-string/jumbo v4, "Patterns"

    const-string/jumbo v5, "getWebUrlPattern(), IWebProtocolNames fail to create plugin instance"
