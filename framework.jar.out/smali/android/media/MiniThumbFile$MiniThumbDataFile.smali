...
.method public constructor <init>(Landroid/media/MiniThumbFile;Ljava/io/RandomAccessFile;Ljava/lang/String;)V
    .locals 8
    .param p1, "this$0"    # Landroid/media/MiniThumbFile;
    ...
    .line 389
    :goto_0
    const-string/jumbo v0, "MiniThumbFile"

    new-instance v1, Ljava/lang/StringBuilder;

    invoke-direct {v1}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v2, "Create MiniThumbDataFile with size "
...
.method private declared-synchronized load()Z
    ...
    invoke-static {v3}, Landroid/media/MiniThumbFile;->-get2(Landroid/media/MiniThumbFile;)[B
    ...
    .line 396
    const-string/jumbo v2, "MiniThumbFile"

    const-string/jumbo v3, "cannot read version header"
    ...
    invoke-static {v2, v3, v4}, Landroid/media/MiniThumbFile;->-wrap0(Landroid/media/MiniThumbFile;[BI)I
    ...
    const-string/jumbo v3, "miss MiniThumbDataFile version"
    ...
    invoke-static {v2, v3, v4}, Landroid/media/MiniThumbFile;->-wrap3(Landroid/media/MiniThumbFile;[BI)J
    ...
    const-string/jumbo v3, "miss MiniThumbDataFile magic"
    ...
    iput v2, p0, Landroid/media/MiniThumbFile$MiniThumbDataFile;->mActiveCount:I
    ...
    const-string/jumbo v3, "active count big than limit, need reset"
    ...
    invoke-static {v5}, Landroid/media/MiniThumbFile;->-get2(Landroid/media/MiniThumbFile;)[B
    ...
    invoke-static {v4, v5, v6, v7}, Landroid/media/MiniThumbFile;->-wrap2(Landroid/media/MiniThumbFile;[BII)J
    ...
    const-string/jumbo v3, "invalid version check sum, version header may be destoried"
    ...
    const-string/jumbo v4, "MiniThumbDataFile size is big than limit(current size = "
    ...
    const-string/jumbo v4, "load MiniThumbDataFile with active count is "
...
.method private declared-synchronized reset()V
    ...
    invoke-static {v1}, Landroid/media/MiniThumbFile;->-get2(Landroid/media/MiniThumbFile;)[B
    ...
    invoke-static {v0, v1, v2, v3}, Landroid/media/MiniThumbFile;->-wrap4(Landroid/media/MiniThumbFile;[BII)V
    ...
    invoke-static {v0, v1, v2, v4, v5}, Landroid/media/MiniThumbFile;->-wrap5(Landroid/media/MiniThumbFile;[BIJ)V
    ...
    invoke-static {v0, v1, v3, v2}, Landroid/media/MiniThumbFile;->-wrap4(Landroid/media/MiniThumbFile;[BII)V
    ...
    invoke-static {v2, v3, v4, v5}, Landroid/media/MiniThumbFile;->-wrap2(Landroid/media/MiniThumbFile;[BII)J

    move-result-wide v2

    const/16 v4, 0x18

    invoke-static {v0, v1, v4, v2, v3}, Landroid/media/MiniThumbFile;->-wrap5(Landroid/media/MiniThumbFile;[BIJ)V
...
.method public bufferToString([B)Ljava/lang/String;
    ...
    invoke-static {v2, p1, v3}, Landroid/media/MiniThumbFile;->-wrap3(Landroid/media/MiniThumbFile;[BI)J
    ...
    .line 619
    const-string/jumbo v1, ", data checksum = "
    ...
    invoke-static {v2, p1, v3}, Landroid/media/MiniThumbFile;->-wrap0(Landroid/media/MiniThumbFile;[BI)I
...
.method public declared-synchronized close()V
    ...
    const-string/jumbo v2, "close MiniThumbDataFile "
...
.method public declared-synchronized getActiveCount()I
    ...
    invoke-static {v0, v1, v2}, Landroid/media/MiniThumbFile;->-wrap3(Landroid/media/MiniThumbFile;[BI)J
    ...
    invoke-static {v0, v1, v2}, Landroid/media/MiniThumbFile;->-wrap0(Landroid/media/MiniThumbFile;[BI)I
    ...
    const-string/jumbo v2, "getActiveCount is "
    ...
    const-string/jumbo v1, "invalid version header, reset MiniThumbDataFile"
...
.method public declared-synchronized getDataFromThumbFile([BJLandroid/media/MiniThumbFile$ThumbResult;)[B
    ...
    invoke-static {v5}, Landroid/media/MiniThumbFile;->-get1(Landroid/media/MiniThumbFile;)[B
    ...
    const-string/jumbo v7, "can not get index header for id "
    ...
    invoke-static {v6}, Landroid/media/MiniThumbFile;->-get1(Landroid/media/MiniThumbFile;)[B

    move-result-object v6

    const/4 v7, 0x0

    invoke-static {v5, v6, v7}, Landroid/media/MiniThumbFile;->-wrap3(Landroid/media/MiniThumbFile;[BI)J
    ...
    invoke-static {v5, v6, v7}, Landroid/media/MiniThumbFile;->-wrap0(Landroid/media/MiniThumbFile;[BI)I
    ...
    const-string/jumbo v7, "invalid store original id : store id = "
    ...
    const-string/jumbo v7, ", given id = "
    ...
    const-string/jumbo v7, "invalid store data length: store length = "
    ...
    const-string/jumbo v7, ", given length = "
    ...
    invoke-static {v5}, Landroid/media/MiniThumbFile;->-get0(Landroid/media/MiniThumbFile;)Ljava/nio/ByteBuffer;
    ...
    invoke-static {v6}, Landroid/media/MiniThumbFile;->-get0(Landroid/media/MiniThumbFile;)Ljava/nio/ByteBuffer;
    ...
    invoke-static {v5, v0, v6, v11}, Landroid/media/MiniThumbFile;->-wrap2(Landroid/media/MiniThumbFile;[BII)J
    ...
    const-string/jumbo v7, "getDataFromThumbFile success with "
    ...
    invoke-static {v7}, Landroid/media/MiniThumbFile;->-get1(Landroid/media/MiniThumbFile;)[B
    ...
    const-string/jumbo v6, "getDataFromThumbFile: can not release lock!"
    ...
    const-string/jumbo v7, "getDataFromThumbFile fail with "
    ...
    const-string/jumbo v7, "getDataFromThumbFile: can not release lock!"
...
.method public declared-synchronized getMagic(J)J
    ...
    invoke-static {v4}, Landroid/media/MiniThumbFile;->-get1(Landroid/media/MiniThumbFile;)[B
    ...
    invoke-static {v4, v5, v6}, Landroid/media/MiniThumbFile;->-wrap3(Landroid/media/MiniThumbFile;[BI)J
    ...
    .line 487
    const-string/jumbo v4, "MiniThumbFile"

    new-instance v5, Ljava/lang/StringBuilder;

    invoke-direct {v5}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v6, "getMagic succuss with: id = "
    ...
    const-string/jumbo v6, "getMagic fail for id "
    ...
    const-string/jumbo v6, " with store id is "
...
.method public declared-synchronized updateActiveCount()I
    ...
    invoke-static {v2}, Landroid/media/MiniThumbFile;->-get2(Landroid/media/MiniThumbFile;)[B
    ...
    invoke-static {v1, v2, v3, v4}, Landroid/media/MiniThumbFile;->-wrap4(Landroid/media/MiniThumbFile;[BII)V
    ...
    invoke-static {v1, v2, v3, v4, v5}, Landroid/media/MiniThumbFile;->-wrap5(Landroid/media/MiniThumbFile;[BIJ)V
    ...
    invoke-static {v1, v2, v3, v0}, Landroid/media/MiniThumbFile;->-wrap4(Landroid/media/MiniThumbFile;[BII)V
    ...
    invoke-static {v4}, Landroid/media/MiniThumbFile;->-get2(Landroid/media/MiniThumbFile;)[B
    ...
    invoke-static {v3, v4, v5, v6}, Landroid/media/MiniThumbFile;->-wrap2(Landroid/media/MiniThumbFile;[BII)J
...
.method public declared-synchronized updateDataToThumbFile([BJJ)V
    ...
    invoke-static {v1}, Landroid/media/MiniThumbFile;->-get1(Landroid/media/MiniThumbFile;)[B
    ...
    invoke-static {v2}, Landroid/media/MiniThumbFile;->-get1(Landroid/media/MiniThumbFile;)[B

    move-result-object v2

    const/4 v3, 0x0

    invoke-static {v1, v2, v3}, Landroid/media/MiniThumbFile;->-wrap3(Landroid/media/MiniThumbFile;[BI)J
    ...
    invoke-static {v1, v2, v3}, Landroid/media/MiniThumbFile;->-wrap0(Landroid/media/MiniThumbFile;[BI)I
    ...
    invoke-static {v1, v2, v3, p2, p3}, Landroid/media/MiniThumbFile;->-wrap5(Landroid/media/MiniThumbFile;[BIJ)V
    ...
    invoke-static {v1, v2, v3, p4, p5}, Landroid/media/MiniThumbFile;->-wrap5(Landroid/media/MiniThumbFile;[BIJ)V
    ...
    invoke-static {v3, p1}, Landroid/media/MiniThumbFile;->-wrap1(Landroid/media/MiniThumbFile;[B)J
    ...
    invoke-static {v1, v2, v3, v8}, Landroid/media/MiniThumbFile;->-wrap4(Landroid/media/MiniThumbFile;[BII)V
    ...
    invoke-static {v1, v2, v4, v3}, Landroid/media/MiniThumbFile;->-wrap4(Landroid/media/MiniThumbFile;[BII)V
    ...
    invoke-static {v1}, Landroid/media/MiniThumbFile;->-get0(Landroid/media/MiniThumbFile;)Ljava/nio/ByteBuffer;
    ...
    invoke-static {v2}, Landroid/media/MiniThumbFile;->-get0(Landroid/media/MiniThumbFile;)Ljava/nio/ByteBuffer;
    ...
    invoke-static {v3}, Landroid/media/MiniThumbFile;->-get1(Landroid/media/MiniThumbFile;)[B
