...
# direct methods
.method static synthetic -get0(Landroid/media/MiniThumbFile;)Ljava/nio/ByteBuffer;
    .locals 1
...
.method static synthetic -get1(Landroid/media/MiniThumbFile;)[B
    .locals 1
...
.method static synthetic -get2(Landroid/media/MiniThumbFile;)[B
    .locals 1
...
.method static synthetic -wrap0(Landroid/media/MiniThumbFile;[BI)I
    .locals 1
    .param p1, "buf"    # [B
    .param p2, "offset"    # I
...
.method static synthetic -wrap1(Landroid/media/MiniThumbFile;[B)J
    .locals 2
    .param p1, "data"    # [B
...
.method static synthetic -wrap2(Landroid/media/MiniThumbFile;[BII)J
    .locals 2
    .param p1, "data"    # [B
    .param p2, "offset"    # I
    .param p3, "length"    # I
...
.method static synthetic -wrap3(Landroid/media/MiniThumbFile;[BI)J
    .locals 2
    .param p1, "buf"    # [B
    .param p2, "offset"    # I
...
.method static synthetic -wrap4(Landroid/media/MiniThumbFile;[BII)V
    .locals 0
    .param p1, "buf"    # [B
    .param p2, "offset"    # I
    .param p3, "value"    # I
...
.method static synthetic -wrap5(Landroid/media/MiniThumbFile;[BIJ)V
    .locals 1
    .param p1, "buf"    # [B
    .param p2, "offset"    # I
    .param p3, "value"    # J
...
.method public constructor <init>(Landroid/net/Uri;)V
    ...
    const-string/jumbo v2, "activate MiniThumbFile "
...
.method public static getMiniThumbFilePrefix()Ljava/lang/String;
    ...
    .prologue
    .line 312
    const-string/jumbo v0, ".thumbdata-6.0_"
...
.method private miniThumbDataFile(J)Landroid/media/MiniThumbFile$MiniThumbDataFile;
    ...
    .line 179
    const-string/jumbo v9, "MiniThumbFile"

    new-instance v11, Ljava/lang/StringBuilder;

    invoke-direct {v11}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v12, "Unable to create .thumbnails directory "
    ...
    const-string/jumbo v12, ", try read only mode"
...
.method public declared-synchronized deactivate()V
    ...
    const-string/jumbo v5, "deactivate MiniThumbFile "
...
.method public declared-synchronized getMagic(J)J
    ...
    .line 231
    .local v4, "miniThumbDataFile":Landroid/media/MiniThumbFile$MiniThumbDataFile;
    if-eqz v4, :cond_0

    .line 233
    :try_start_1
    invoke-virtual {v4, p1, p2}, Landroid/media/MiniThumbFile$MiniThumbDataFile;->getMagic(J)J
    :try_end_1
    ...
    const-string/jumbo v7, "Got exception when reading magic, id = "
    ...
    .line 240
    invoke-virtual {v1}, Ljava/lang/RuntimeException;->getClass()Ljava/lang/Class;
    ...
    const-string/jumbo v6, "Got exception checking file magic: "
    ...
    .end local v4    # "miniThumbDataFile":Landroid/media/MiniThumbFile$MiniThumbDataFile;
    :catchall_0
    move-exception v5
...
.method public declared-synchronized getMiniThumbFromFile(J[BLandroid/media/MiniThumbFile$ThumbResult;)[B
    ...
    const-string/jumbo v5, "getMiniThumbFromFile for id "
    ...
    .line 296
    invoke-virtual {v2, p3, p1, p2, p4}, Landroid/media/MiniThumbFile$MiniThumbDataFile;->getDataFromThumbFile([BJLandroid/media/MiniThumbFile$ThumbResult;)[B
    :try_end_1
    .catch Ljava/io/IOException; {:try_start_1 .. :try_end_1} :catch_1
    .catch Ljava/lang/RuntimeException; {:try_start_1 .. :try_end_1} :catch_0
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    const-string/jumbo v5, "Got exception when reading thumbnail, id = "
...
.method public declared-synchronized saveMiniThumbToFile([BJJ)V
    ...
    const-string/jumbo v3, "couldn\'t save mini thumbnail data for "
    ...
    .line 260
    const-string/jumbo v3, "; disk full or mount read-only? "
