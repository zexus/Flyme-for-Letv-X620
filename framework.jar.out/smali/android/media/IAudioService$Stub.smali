...
.field static final TRANSACTION_setMuteButtonState:I = 0x48
...
.field static final TRANSACTION_updateMuteKeyAffectedStreams:I = 0x49
...
.method public onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    .line 119
    .local v40, "_arg1":Landroid/os/IBinder;
    move-object/from16 v0, p0
    ...
    .end local v40    # "_arg1":Landroid/os/IBinder;
    :cond_1
    const/16 v37, 0x0
    ...
    .line 286
    .restart local v40    # "_arg1":Landroid/os/IBinder;
    invoke-virtual/range {p2 .. p2}, Landroid/os/Parcel;->readString()Ljava/lang/String;
    ...
    .local v43, "_arg2":Landroid/media/AudioAttributes;
    goto :goto_10

    .line 448
    .end local v26    # "_arg0":Landroid/media/IAudioFocusDispatcher;
    .end local v41    # "_arg1":Ljava/lang/String;
    .end local v43    # "_arg2":Landroid/media/AudioAttributes;
    :sswitch_26
    const-string/jumbo v4, "android.media.IAudioService"
    ...
    invoke-virtual {v0, v1}, Landroid/media/IAudioService$Stub;->isAppInFocus(Ljava/lang/String;)Z
    ...
    .local v46, "_arg3":Landroid/content/ComponentName;
    goto :goto_13

    .line 505
    .end local v46    # "_arg3":Landroid/content/ComponentName;
    .restart local v52    # "_result":Z
    :cond_14
    const/4 v4, 0x0
    ...
    invoke-virtual {v0, v1}, Landroid/media/IAudioService$Stub;->setAudioPathToFMTx(Landroid/os/IBinder;)Z
    ...
    .line 796
    invoke-virtual/range {p0 .. p0}, Landroid/media/IAudioService$Stub;->setAudioPathOutofFMTx()Z
    ...
    invoke-virtual {v0, v5, v6, v7}, Landroid/media/IAudioService$Stub;->setAudioProfileStreamVolume(III)V
    ...
    invoke-static {v4}, Lcom/mediatek/common/audioprofile/IAudioProfileListener$Stub;->asInterface(Landroid/os/IBinder;)Lcom/mediatek/common/audioprofile/IAudioProfileListener;

    move-result-object v35

    .line 820
    .local v35, "_arg0":Lcom/mediatek/common/audioprofile/IAudioProfileListener;
    invoke-virtual/range {p2 .. p2}, Landroid/os/Parcel;->readInt()I
    ...
    invoke-virtual {v0, v1, v6}, Landroid/media/IAudioService$Stub;->listenRingerModeAndVolume(Lcom/mediatek/common/audioprofile/IAudioProfileListener;I)V
    ...
    .line 826
    .end local v6    # "_arg1":I
    .end local v35    # "_arg0":Lcom/mediatek/common/audioprofile/IAudioProfileListener;
    :sswitch_48
    const-string/jumbo v4, "android.media.IAudioService"
    ...
    invoke-virtual {v0, v1, v6, v2, v3}, Landroid/media/IAudioService$Stub;->setMuteButtonState(Ljava/lang/String;IZLandroid/os/IBinder;)V
    ...
    invoke-virtual {v0, v1}, Landroid/media/IAudioService$Stub;->updateMuteKeyAffectedStreams(Landroid/os/IBinder;)V
