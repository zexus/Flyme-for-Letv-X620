...
.field static final TRANSACTION_destroy_6:I = 0x7

.field static final TRANSACTION_getCallingPackage:I = 0x15
...
.field static final TRANSACTION_setLaunchPendingIntent_5:I = 0x6

.field static final TRANSACTION_setMediaButtonReceiver_4:I = 0x5

.field static final TRANSACTION_setMetadata_7:I = 0x8
...
.method public onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    .line 46
    :sswitch_0
    const-string/jumbo v17, "android.media.session.ISession"
    ...
    invoke-virtual {v0, v10, v14}, Landroid/media/session/ISession$Stub;->sendEvent(Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    .line 69
    .local v15, "_result":Landroid/media/session/ISessionController;
    invoke-virtual/range {p3 .. p3}, Landroid/os/Parcel;->writeNoException()V

    .line 70
    if-eqz v15, :cond_1

    invoke-interface {v15}, Landroid/media/session/ISessionController;->asBinder()Landroid/os/IBinder;
    ...
    .line 75
    .end local v15    # "_result":Landroid/media/session/ISessionController;
    :sswitch_3
    const-string/jumbo v17, "android.media.session.ISession"
    ...
    invoke-virtual {v0, v2}, Landroid/media/session/ISession$Stub;->setFlags(I)V
    ...
    invoke-virtual {v0, v11}, Landroid/media/session/ISession$Stub;->setActive(Z)V
    ...
    invoke-virtual {v0, v3}, Landroid/media/session/ISession$Stub;->setMediaButtonReceiver(Landroid/app/PendingIntent;)V
    ...
    invoke-virtual {v0, v3}, Landroid/media/session/ISession$Stub;->setLaunchPendingIntent(Landroid/app/PendingIntent;)V
    ...
    .line 131
    sget-object v17, Landroid/media/MediaMetadata;->CREATOR:Landroid/os/Parcelable$Creator;
    ...
    check-cast v6, Landroid/media/MediaMetadata;

    .line 136
    :goto_5
    move-object/from16 v0, p0

    invoke-virtual {v0, v6}, Landroid/media/session/ISession$Stub;->setMetadata(Landroid/media/MediaMetadata;)V
    ...
    .local v6, "_arg0":Landroid/media/MediaMetadata;
    goto :goto_5

    .line 142
    .end local v6    # "_arg0":Landroid/media/MediaMetadata;
    :sswitch_9
    const-string/jumbo v17, "android.media.session.ISession"
    ...
    .line 145
    sget-object v17, Landroid/media/session/PlaybackState;->CREATOR:Landroid/os/Parcelable$Creator;
    ...
    invoke-virtual {v0, v7}, Landroid/media/session/ISession$Stub;->setPlaybackState(Landroid/media/session/PlaybackState;)V
    ...
    .local v7, "_arg0":Landroid/media/session/PlaybackState;
    goto :goto_6

    .line 156
    .end local v7    # "_arg0":Landroid/media/session/PlaybackState;
    :sswitch_a
    const-string/jumbo v17, "android.media.session.ISession"
    ...
    invoke-virtual {v0, v4}, Landroid/media/session/ISession$Stub;->setQueue(Landroid/content/pm/ParceledListSlice;)V
    ...
    .local v4, "_arg0":Landroid/content/pm/ParceledListSlice;
    goto :goto_7

    .line 170
    .end local v4    # "_arg0":Landroid/content/pm/ParceledListSlice;
    :sswitch_b
    const-string/jumbo v17, "android.media.session.ISession"
    ...
    invoke-virtual {v0, v9}, Landroid/media/session/ISession$Stub;->setQueueTitle(Ljava/lang/CharSequence;)V
    ...
    .local v9, "_arg0":Ljava/lang/CharSequence;
    goto :goto_8

    .line 184
    .end local v9    # "_arg0":Ljava/lang/CharSequence;
    :sswitch_c
    const-string/jumbo v17, "android.media.session.ISession"
    ...
    invoke-virtual {v0, v8}, Landroid/media/session/ISession$Stub;->setExtras(Landroid/os/Bundle;)V
    ...
    invoke-virtual {v0, v2}, Landroid/media/session/ISession$Stub;->setRatingType(I)V
    ...
    invoke-virtual {v0, v11}, Landroid/media/session/ISession$Stub;->playItemResponse(Z)V
    ...
    invoke-virtual {v0, v12}, Landroid/media/session/ISession$Stub;->updateNowPlayingEntries([J)V
    ...
    invoke-virtual {v0, v10}, Landroid/media/session/ISession$Stub;->updateFolderInfoBrowsedPlayer(Ljava/lang/String;)V
    ...
    .line 244
    sget-object v17, Landroid/media/AudioAttributes;->CREATOR:Landroid/os/Parcelable$Creator;
    ...
    invoke-virtual {v0, v5}, Landroid/media/session/ISession$Stub;->setPlaybackToLocal(Landroid/media/AudioAttributes;)V
    ...
    .local v5, "_arg0":Landroid/media/AudioAttributes;
    goto :goto_b

    .line 255
    .end local v5    # "_arg0":Landroid/media/AudioAttributes;
    :sswitch_13
    const-string/jumbo v17, "android.media.session.ISession"
    ...
    invoke-virtual {v0, v2, v13}, Landroid/media/session/ISession$Stub;->setPlaybackToRemote(II)V
    ...
    invoke-virtual {v0, v2}, Landroid/media/session/ISession$Stub;->setCurrentVolume(I)V
