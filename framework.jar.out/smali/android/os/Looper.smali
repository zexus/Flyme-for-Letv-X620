...
.method public static loop()V
    ...
    const-string/jumbo v13, "No Looper; Looper.prepare() wasn\'t called on this thread."
    ...
    const-string/jumbo v13, ">>>>> Dispatching to "
    ...
    .line 188
    const-string/jumbo v12, "Looper"

    new-instance v13, Ljava/lang/StringBuilder;

    invoke-direct {v13}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v14, "RemoveMessages PENDING_TIMEOUT_MSG msg= "
    ...
    const-string/jumbo v13, "<<<<< Finished to "
    ...
    const-string/jumbo v14, "RemoveMessages EXECUTION_TIMEOUT msg="
    ...
    const-string/jumbo v14, "Thread identity changed from 0x"
    ...
    .line 235
    const-string/jumbo v14, " while dispatching to "
    ...
    invoke-virtual {v14}, Landroid/os/Handler;->getClass()Ljava/lang/Class;
    ...
    const-string/jumbo v13, "Execution timeout <100 ms!"
    ...
    const-string/jumbo v14, "Execution timeout exception "
...
.method private static prepare(Z)V
    ...
    const-string/jumbo v3, "Only one Looper may be created per thread"
    ...
    const-string/jumbo v3, "WARNING: The Looper class instance count has over a limit(100). There should be some leakage of Looper or HandlerThread."
    ...
    const-string/jumbo v4, "Looper class instance count = "
    ...
    const-string/jumbo v4, "Current Thread Name: "
