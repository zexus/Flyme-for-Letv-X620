...
.method static constructor <clinit>()V
    ...
    .line 90
    const-string/jumbo v0, "go_dev_addr=((?:[0-9a-f]{2}:){5}[0-9a-f]{2}) ?(\\[PERSISTENT\\])?"
...
.method public constructor <init>(Ljava/lang/String;)V
    ...
    const-string/jumbo v8, "Malformed supplicant event"
    ...
    const-string/jumbo v9, "P2P-GROUP"
    ...
    sget-object v7, Landroid/net/wifi/p2p/WifiP2pGroup;->groupStartedPattern2:Ljava/util/regex/Pattern;
    ...
    .line 129
    .local v2, "match2":Ljava/util/regex/Matcher;
    if-eqz v1, :cond_3
    ...
    iput v7, p0, Landroid/net/wifi/p2p/WifiP2pGroup;->mFreq:I
    ...
    .line 141
    :goto_0
    const-string/jumbo v7, "WifiP2pGroup"

    new-instance v8, Ljava/lang/StringBuilder;

    invoke-direct {v8}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v9, "Normal match! frequency = "

    invoke-virtual {v8, v9}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v8

    iget v9, p0, Landroid/net/wifi/p2p/WifiP2pGroup;->mFreq:I
    ...
    .end local v2    # "match2":Ljava/util/regex/Matcher;
    :cond_1
    :goto_1
    return-void
    ...
    .restart local v2    # "match2":Ljava/util/regex/Matcher;
    :cond_2
    const/4 v7, -0x1

    iput v7, p0, Landroid/net/wifi/p2p/WifiP2pGroup;->mNetId:I
    ...
    const-string/jumbo v8, "Not matched SSID, but matched device address!"
    ...
    const-string/jumbo v8, "Match nothing!"
    ...
    const-string/jumbo v9, "P2P-INVITATION-RECEIVED"
    ...
    const-string/jumbo v11, "go_dev_addr"
    ...
    invoke-direct {v10, v4}, Landroid/net/wifi/p2p/WifiP2pDevice;-><init>(Ljava/lang/String;)V
