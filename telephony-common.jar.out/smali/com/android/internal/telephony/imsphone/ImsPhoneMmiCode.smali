...
.field private static final EVENT_SET_CLIR_COMPLETE:I = 0x8
...
.method public getUssdDialString()Ljava/lang/String;
    .locals 3
    ...
    const-string/jumbo v2, "getUssdDialString(): mDialingNumber="
    ...
    .line 1792
    const-string/jumbo v2, ", mPoundString="
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    .line 1110
    sget-object v7, Lcom/android/internal/telephony/CommandException$Error;->UT_XCAP_403_FORBIDDEN:Lcom/android/internal/telephony/CommandException$Error;

    .line 1109
    if-ne v6, v7, :cond_0

    .line 1111
    const-string/jumbo v6, "ImsPhoneMmiCode"

    const-string/jumbo v7, "handleMessage(): CommandException.Error.UT_XCAP_403_FORBIDDEN"
    ...
    invoke-virtual {v6, v8}, Lcom/android/internal/telephony/imsphone/ImsPhone;->handleMmiCodeCsfb(I)V
    ...
    .line 1116
    sget-object v7, Lcom/android/internal/telephony/CommandException$Error;->UT_UNKNOWN_HOST:Lcom/android/internal/telephony/CommandException$Error;
    ...
    const-string/jumbo v7, "handleMessage(): CommandException.Error.UT_UNKNOWN_HOST"
    ...
    invoke-virtual {v6, v11}, Lcom/android/internal/telephony/imsphone/ImsPhone;->handleMmiCodeCsfb(I)V
    ...
    check-cast v5, Lcom/android/ims/ImsException;

    .line 1123
    .local v5, "imsException":Lcom/android/ims/ImsException;
    ...
    const-string/jumbo v7, "handleMessage(): ImsReasonInfo.CODE_UT_XCAP_403_FORBIDDEN"
    ...
    const-string/jumbo v7, "handleMessage(): ImsReasonInfo.CODE_UT_UNKNOWN_HOST"
    ...
    .line 1135
    .end local v5    # "imsException":Lcom/android/ims/ImsException;
    :cond_3
    ...
    invoke-virtual {v6}, Lcom/android/internal/telephony/gsm/GSMPhone;->isOp05IccCard()Z
    ...
    const-string/jumbo v7, "cfInfo is null or length is 0."
    ...
    invoke-virtual {v6, v10, v2, v7}, Lcom/android/internal/telephony/uicc/IccRecords;->setVoiceCallForwardingFlag(IZLjava/lang/String;)V

    .line 1191
    iget-object v6, p0, Lcom/android/internal/telephony/imsphone/ImsPhoneMmiCode;->mPhone:Lcom/android/internal/telephony/imsphone/ImsPhone;

    invoke-virtual {v6, v9}, Lcom/android/internal/telephony/imsphone/ImsPhone;->saveTimeSlot([J)V
    ...
    .line 1195
    const-string/jumbo v7, "persist.radio.ut.cfu.mode"

    const-string/jumbo v8, "enabled_ut_cfu_mode_on"

    .line 1194
    invoke-static {v6, v7, v8}, Landroid/telephony/TelephonyManager;->setTelephonyProperty(ILjava/lang/String;Ljava/lang/String;)V
    ...
    .line 1167
    .restart local v1    # "cfInfos":[Lcom/android/internal/telephony/CallForwardInfo;
    :cond_b
    const/4 v4, 0x0
    ...
    const-string/jumbo v8, "Set CF_ENABLE, serviceClass: "
    ...
    const-string/jumbo v8, "Set CF_DISABLE, serviceClass: "
    ...
    const-string/jumbo v7, "ar.result is null."
    ...
    const-string/jumbo v8, "enabled_ut_cfu_mode_off"
    ...
    iput-boolean v10, v6, Lcom/android/internal/telephony/imsphone/ImsPhone;->mUssiCSFB:Z
    ...
    iput-object v6, p0, Lcom/android/internal/telephony/imsphone/ImsPhoneMmiCode;->mMessage:Ljava/lang/CharSequence;
...
.method isSupportedOverImsPhone()Z
    ...
    const-string/jumbo v4, "exc.toString() = "
...
.method processCode()V
    ...
    iget-object v4, v4, Lcom/android/internal/telephony/imsphone/ImsPhone;->mDefaultPhone:Lcom/android/internal/telephony/PhoneBase;

    invoke-virtual {v4}, Lcom/android/internal/telephony/PhoneBase;->getCsFallbackStatus()I
    ...
    const-string/jumbo v10, "processCode(): getCsFallbackStatus(): CS Fallback!"
    ...
    .line 734
    const-string/jumbo v4, "ro.mtk_ussi_support"
    ...
    const-string/jumbo v20, "Sending short code \'"
    ...
    .line 736
    const-string/jumbo v20, "\' over IMS."
    ...
    iget-object v4, v0, Lcom/android/internal/telephony/imsphone/ImsPhoneMmiCode;->mDialingNumber:Ljava/lang/String;

    move-object/from16 v0, p0

    invoke-virtual {v0, v4}, Lcom/android/internal/telephony/imsphone/ImsPhoneMmiCode;->sendUssd(Ljava/lang/String;)V
    ...
    .line 741
    const-string/jumbo v20, "\' over CS pipe."
    ...
    .line 786
    .local v16, "isSettingUnconditional":I
    :goto_2
    const/4 v4, 0x1
    ...
    invoke-virtual {v0, v10, v1, v15, v2}, Lcom/android/internal/telephony/imsphone/ImsPhoneMmiCode;->obtainMessage(IIILjava/lang/Object;)Landroid/os/Message;
    ...
    .end local v15    # "isEnableDesired":I
    .end local v16    # "isSettingUnconditional":I
    :cond_7
    const/4 v5, 0x3
    ...
    .restart local v16    # "isSettingUnconditional":I
    goto :goto_2
    ...
    .restart local v15    # "isEnableDesired":I
    goto :goto_3
    ...
    .line 805
    invoke-virtual {v4, v14, v10}, Lcom/android/internal/telephony/imsphone/ImsPhone;->getCallBarring(Ljava/lang/String;Landroid/os/Message;)V
    ...
    invoke-virtual {v4, v14, v10, v0, v1}, Lcom/android/internal/telephony/imsphone/ImsPhone;->setCallBarring(Ljava/lang/String;ZLjava/lang/String;Landroid/os/Message;)V
    ...
    invoke-virtual {v0, v4, v10, v1, v2}, Lcom/android/internal/telephony/imsphone/ImsPhoneMmiCode;->obtainMessage(IIILjava/lang/Object;)Landroid/os/Message;
    ...
    invoke-interface {v4, v0, v10}, Lcom/android/ims/ImsUtInterface;->updateCLIR(ILandroid/os/Message;)V
    :try_end_2
    ...
    .line 851
    .restart local v12    # "e":Lcom/android/ims/ImsException;
    :try_start_5
    const-string/jumbo v4, "ImsPhoneMmiCode"
    ...
    invoke-interface {v4, v0, v10}, Lcom/android/ims/ImsUtInterface;->updateCOLR(ILandroid/os/Message;)V
    :try_end_10
    ...
    invoke-interface {v4, v0, v10}, Lcom/android/ims/ImsUtInterface;->queryCallBarring(ILandroid/os/Message;)V
    :try_end_16
    ...
    .line 968
    const-string/jumbo v10, "persist.radio.terminal-based.cw"

    .line 969
    const-string/jumbo v20, "disabled_tbcw"

    .line 967
    move-object/from16 v0, v20

    invoke-virtual {v4, v10, v0}, Lcom/android/internal/telephony/PhoneBase;->getSystemProperty(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v19

    .line 970
    .local v19, "tbcwMode":Ljava/lang/String;
    const-string/jumbo v4, "ImsPhoneMmiCode"
    ...
    const-string/jumbo v20, "setCallWaiting(): tbcwMode = "
    ...
    .line 972
    const-string/jumbo v4, "enabled_tbcw_on"
    ...
    .line 976
    const-string/jumbo v20, "enabled_tbcw_off"

    .line 974
    move-object/from16 v0, v20

    invoke-virtual {v4, v10, v0}, Lcom/android/internal/telephony/PhoneBase;->setSystemProperty(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v4, v10}, Lcom/android/internal/telephony/imsphone/ImsPhoneMmiCode;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;
    ...
    invoke-virtual {v0, v1}, Lcom/android/internal/telephony/imsphone/ImsPhoneMmiCode;->sendMessage(Landroid/os/Message;)Z
    ...
    .end local v17    # "msg":Landroid/os/Message;
    :cond_2f
    const-string/jumbo v4, "enabled_tbcw_off"
    ...
    .line 985
    const-string/jumbo v20, "enabled_tbcw_on"
    ...
    .line 994
    .end local v19    # "tbcwMode":Ljava/lang/String;
    :cond_32
    invoke-virtual/range {p0 .. p0}, Lcom/android/internal/telephony/imsphone/ImsPhoneMmiCode;->isInterrogate()Z
    ...
    .line 999
    .restart local v19    # "tbcwMode":Ljava/lang/String;
    const-string/jumbo v4, "ImsPhoneMmiCode"
    ...
    const-string/jumbo v20, "SC_WAIT isInterrogate() tbcwMode = "
    ...
    invoke-static {v0, v11, v4}, Landroid/os/AsyncResult;->forMessage(Landroid/os/Message;Ljava/lang/Object;Ljava/lang/Throwable;)Landroid/os/AsyncResult;
    ...
    const-string/jumbo v20, "Sending pound string \'"
    ...
    iget-object v0, v0, Lcom/android/internal/telephony/imsphone/ImsPhoneMmiCode;->mPoundString:Ljava/lang/String;
