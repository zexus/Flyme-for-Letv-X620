...
.field protected static final EVENT_DELAY_SEND_MESSAGE_QUEUE:I = 0x6b
...
.method static constructor <clinit>()V
    ...
    .line 267
    const-string/jumbo v0, "msg_ref_num"
...
.method protected constructor <init>(Lcom/android/internal/telephony/PhoneBase;Lcom/android/internal/telephony/SmsUsageMonitor;Lcom/android/internal/telephony/ImsSMSDispatcher;)V
    ...
    .line 259
    iput-boolean v2, p0, Lcom/android/internal/telephony/SMSDispatcher;->mSmsReady:Z
    ...
    .line 286
    const-string/jumbo v4, "sms_short_code_rule"
...
.method protected static getAppNameByIntent(Landroid/app/PendingIntent;)Ljava/lang/String;
    ...
    .line 1462
    :cond_0
    const-string/jumbo v1, "Resource unusable"
...
.method protected static handleNotInService(ILandroid/app/PendingIntent;)V
    ...
    const-string/jumbo v2, "CanceledException happenedwhen send sms fail with sentIntent due to no service"
    ...
    const-string/jumbo v2, "Send sms fail without sentIntent due to no service"
...
.method private notifySmsReady(Z)V
    ...
    const-string/jumbo v1, "android.provider.Telephony.SMS_STATE_CHANGED"
...
.method private sendMultipartSms(Lcom/android/internal/telephony/SMSDispatcher$SmsTracker;)V
    ...
    .line 1534
    :cond_0
    iget-boolean v8, p1, Lcom/android/internal/telephony/SMSDispatcher$SmsTracker;->mPersistMessage:Z
...
.method checkDestination(Lcom/android/internal/telephony/SMSDispatcher$SmsTracker;)Z
    ...
    invoke-virtual {v6, v7}, Landroid/telephony/TelephonyManager;->getSimCountryIso(I)Ljava/lang/String;
    ...
    .line 1253
    invoke-virtual {v6, v7}, Landroid/telephony/TelephonyManager;->getNetworkCountryIsoForSubscription(I)Ljava/lang/String;
...
.method protected finalize()V
    ...
    .prologue
    .line 380
    invoke-super {p0}, Landroid/os/Handler;->finalize()V

    .line 381
    const-string/jumbo v0, "SMSDispatcher"

    const-string/jumbo v1, "SMSDispatcher finalized"
...
.method protected getSmsTracker(Ljava/util/HashMap;Landroid/app/PendingIntent;Landroid/app/PendingIntent;Ljava/lang/String;Ljava/util/concurrent/atomic/AtomicInteger;Ljava/util/concurrent/atomic/AtomicBoolean;Landroid/net/Uri;Lcom/android/internal/telephony/SmsHeader;ZLjava/lang/String;ZZ)Lcom/android/internal/telephony/SMSDispatcher$SmsTracker;
    ...
    const-string/jumbo v4, "SmsTrackerFactory and get the package name via process id: "
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    const-string/jumbo v4, "handleMessage() ignoring message of unexpected type "
    ...
    const-string/jumbo v3, "SMS retry.."
    ...
    const-string/jumbo v5, "SMS is ready, Phone: "
    ...
    const-string/jumbo v3, "[copyText success to copy one"
    ...
    const-string/jumbo v3, "[copyText fail to copy one"
...
.method protected handleQueryCbActivation(Landroid/os/AsyncResult;)V
    ...
    const-string/jumbo v1, "didn\'t support cellBoradcast in the CDMA phone"
...
.method protected handleSendComplete(Landroid/os/AsyncResult;)V
    ...
    .line 822
    :cond_1
    const-string/jumbo v5, "SMSDispatcher"

    const-string/jumbo v6, "SmsResponse was null"
    ...
    const-string/jumbo v7, "handleSendComplete: Skipping retry:  isIms()="
    ...
    invoke-virtual {v4, v5, v6, v8}, Lcom/android/internal/telephony/SMSDispatcher$SmsTracker;->onFailed(Landroid/content/Context;II)V
...
.method protected handleSendNextTracker(Lcom/android/internal/telephony/SMSDispatcher$SmsTracker;)V
    ...
    .end local v2    # "pduLength":I
    .end local v3    # "smscLength":I
    :cond_2
    :goto_0
    const/4 v1, 0x0
    ...
    const-string/jumbo v8, "Remove Tracker"

    invoke-static {v6, v8}, Landroid/telephony/Rlog;->d(Ljava/lang/String;Ljava/lang/String;)I

    .line 2439
    iget-object v6, p0, Lcom/android/internal/telephony/SMSDispatcher;->mSTrackersQueue:Ljava/util/ArrayList;
    ...
    invoke-virtual {v5, p1}, Lcom/android/internal/telephony/SMSDispatcher$SmsTracker;->equals(Ljava/lang/Object;)Z
    ...
    const-string/jumbo v9, "[pdu size: "
    ...
    const-string/jumbo v7, "Current tracker is null"
    ...
    .line 2440
    .restart local v1    # "nextTracker":Lcom/android/internal/telephony/SMSDispatcher$SmsTracker;
    :cond_6
    const/4 v5, 0x0

    .local v5, "tempTracker":Lcom/android/internal/telephony/SMSDispatcher$SmsTracker;
    goto :goto_1

    .line 2436
    .end local v1    # "nextTracker":Lcom/android/internal/telephony/SMSDispatcher$SmsTracker;
    .end local v5    # "tempTracker":Lcom/android/internal/telephony/SMSDispatcher$SmsTracker;
    :catchall_0
    move-exception v6
    ...
    const-string/jumbo v7, "mSTrackersQueue is empty"
...
.method protected sendRawPdu(Lcom/android/internal/telephony/SMSDispatcher$SmsTracker;)V
    ...
    const-string/jumbo v8, "Device does not support sending sms."
    ...
    const-string/jumbo v8, "Empty PDU"
    ...
    const-string/jumbo v8, "Can\'t get calling app package name: refusing to send SMS"
    ...
    const-string/jumbo v9, "sendRawPdu and get the package name via process id: "
    ...
    const-string/jumbo v8, "Can\'t get calling app package info: refusing to send SMS"
...
.method protected updatePhoneObject(Lcom/android/internal/telephony/PhoneBase;)V
    ...
    const-string/jumbo v2, "updatePhoneObject, remove tracker."
