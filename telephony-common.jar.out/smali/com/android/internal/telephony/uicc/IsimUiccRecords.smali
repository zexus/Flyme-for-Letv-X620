...
.field private static final EVENT_AKA_AUTHENTICATE_DONE:I = 0x5b
...
.method static synthetic -wrap1(Lcom/android/internal/telephony/uicc/IsimUiccRecords;)V
    .locals 0
...
.method private fetchGbaParam()V
    ...
    invoke-virtual {p0, v1}, Lcom/android/internal/telephony/uicc/IsimUiccRecords;->obtainMessage(I)Landroid/os/Message;
...
.method private handleIsimRefresh(Lcom/android/internal/telephony/uicc/IccRefreshResponse;)V
    ...
    .line 484
    const-string/jumbo v1, "handleIsimRefresh received without input"
    ...
    .line 491
    :cond_3
    const-string/jumbo v1, "handleIsimRefresh received different app"
    ...
    .line 497
    :pswitch_0
    const-string/jumbo v1, "handleIsimRefresh with REFRESH_RESULT_FILE_UPDATE"
    ...
    .end local v0    # "i":I
    :pswitch_1
    const-string/jumbo v1, "handleIsimRefresh with REFRESH_RESULT_INIT"
    ...
    .line 515
    :pswitch_2
    const-string/jumbo v1, "handleIsimRefresh with REFRESH_RESULT_RESET"
...
.method getChildPhoneId()I
    ...
    .prologue
    .line 718
    const-string/jumbo v0, "[getChildPhoneId] return -1 for iSimUiccRecords"
...
.method public getIsimGbabp()Ljava/lang/String;
    ...
    const-string/jumbo v1, "ISIM GBABP = "
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    iget-object v6, p0, Lcom/android/internal/telephony/uicc/IsimUiccRecords;->mDestroyed:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    .line 153
    const-string/jumbo v6, "IsimUiccRecords"

    new-instance v7, Ljava/lang/StringBuilder;

    invoke-direct {v7}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v8, "Received message "
    ...
    const-string/jumbo v7, "IsimUiccRecords: handleMessage "
    ...
    invoke-virtual {p0, v6}, Lcom/android/internal/telephony/uicc/IsimUiccRecords;->loge(Ljava/lang/String;)V
    ...
    const-string/jumbo v7, "ISim REFRESH(EVENT_ISIM_REFRESH) with exception: "
    ...
    const-string/jumbo v6, "com.android.intent.isim_refresh"

    invoke-direct {v4, v6}, Landroid/content/Intent;-><init>(Ljava/lang/String;)V

    .line 170
    .local v4, "intent":Landroid/content/Intent;
    const-string/jumbo v6, "send ISim REFRESH: com.android.intent.isim_refresh"

    invoke-virtual {p0, v6}, Lcom/android/internal/telephony/uicc/IsimUiccRecords;->loge(Ljava/lang/String;)V

    .line 171
    iget-object v6, p0, Lcom/android/internal/telephony/uicc/IsimUiccRecords;->mContext:Landroid/content/Context;
    ...
    invoke-direct {p0, v6}, Lcom/android/internal/telephony/uicc/IsimUiccRecords;->handleIsimRefresh(Lcom/android/internal/telephony/uicc/IccRefreshResponse;)V
    :try_end_3
    ...
    invoke-virtual {p0, v6}, Lcom/android/internal/telephony/uicc/IsimUiccRecords;->log(Ljava/lang/String;)V
    ...
    const-string/jumbo v7, "Exception ISIM AKA: "
    ...
    .line 190
    :try_start_5
    iget-object v6, p0, Lcom/android/internal/telephony/uicc/IsimUiccRecords;->mLock:Ljava/lang/Object;
    ...
    iput-object v6, p0, Lcom/android/internal/telephony/uicc/IsimUiccRecords;->auth_rsp:Ljava/lang/String;
    ...
    const-string/jumbo v7, "ISIM AKA: auth_rsp = "

    invoke-virtual {v6, v7}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v6

    iget-object v7, p0, Lcom/android/internal/telephony/uicc/IsimUiccRecords;->auth_rsp:Ljava/lang/String;
    ...
    const-string/jumbo v7, "Failed to parse ISIM AKA contents: "
    ...
    iput-object v6, p0, Lcom/android/internal/telephony/uicc/IsimUiccRecords;->mIsimGbabp:Ljava/lang/String;
    ...
    const-string/jumbo v7, "Error on GET_ISIM_GBABP with exp "
    ...
    iput-object v6, p0, Lcom/android/internal/telephony/uicc/IsimUiccRecords;->mEfGbanlList:Ljava/util/ArrayList;
    ...
    const-string/jumbo v7, "GET_ISIM_GBANL record count: "

    invoke-virtual {v6, v7}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v6

    iget-object v7, p0, Lcom/android/internal/telephony/uicc/IsimUiccRecords;->mEfGbanlList:Ljava/util/ArrayList;
    ...
    const-string/jumbo v7, "Error on GET_ISIM_GBANL with exp "
    ...
    const-string/jumbo v7, "EF_PSISMSC: "
    ...
    .line 231
    iput-object v1, p0, Lcom/android/internal/telephony/uicc/IsimUiccRecords;->mEfPsismsc:[B
    :try_end_8
