...
.field private mInboundAutoRegSmsFwkExt:Lcom/mediatek/common/sms/IInboundAutoRegSmsFwkExt;
...
.method private constructor <init>(Landroid/content/Context;Lcom/android/internal/telephony/SmsStorageMonitor;Lcom/android/internal/telephony/PhoneBase;Lcom/android/internal/telephony/cdma/CdmaSMSDispatcher;)V
    ...
    .line 73
    iput-object v6, p0, Lcom/android/internal/telephony/cdma/CdmaInboundSmsHandler;->mIccFileAdapter:Lcom/mediatek/internal/telephony/uicc/IccFileAdapter;

    .line 77
    iput-object v6, p0, Lcom/android/internal/telephony/cdma/CdmaInboundSmsHandler;->mInboundAutoRegSmsFwkExt:Lcom/mediatek/common/sms/IInboundAutoRegSmsFwkExt;
    ...
    invoke-interface {v0, v1, v2, v6}, Lcom/android/internal/telephony/CommandsInterface;->setOnNewCdmaSms(Landroid/os/Handler;ILjava/lang/Object;)V

    .line 96
    const-class v0, Lcom/mediatek/common/sms/IInboundAutoRegSmsFwkExt;
    ...
    check-cast v0, Lcom/mediatek/common/sms/IInboundAutoRegSmsFwkExt;

    iput-object v0, p0, Lcom/android/internal/telephony/cdma/CdmaInboundSmsHandler;->mInboundAutoRegSmsFwkExt:Lcom/mediatek/common/sms/IInboundAutoRegSmsFwkExt;

    .line 97
    iget-object v0, p0, Lcom/android/internal/telephony/cdma/CdmaInboundSmsHandler;->mInboundAutoRegSmsFwkExt:Lcom/mediatek/common/sms/IInboundAutoRegSmsFwkExt;

    if-nez v0, :cond_0

    .line 98
    const-string/jumbo v0, "Create mInboundAutoRegSmsFwkExt fail."
    ...
    invoke-direct {v0, p1, p3}, Lcom/mediatek/internal/telephony/uicc/IccFileAdapter;-><init>(Landroid/content/Context;Lcom/android/internal/telephony/Phone;)V

    iput-object v0, p0, Lcom/android/internal/telephony/cdma/CdmaInboundSmsHandler;->mIccFileAdapter:Lcom/mediatek/internal/telephony/uicc/IccFileAdapter;
...
.method protected dispatchMessageRadioSpecific(Lcom/android/internal/telephony/SmsMessageBase;)I
    ...
    .line 170
    iget-object v0, p0, Lcom/android/internal/telephony/cdma/CdmaInboundSmsHandler;->mIccFileAdapter:Lcom/mediatek/internal/telephony/uicc/IccFileAdapter;

    if-eqz v0, :cond_2

    iget-object v0, p0, Lcom/android/internal/telephony/cdma/CdmaInboundSmsHandler;->mIccFileAdapter:Lcom/mediatek/internal/telephony/uicc/IccFileAdapter;

    invoke-virtual {v0}, Lcom/mediatek/internal/telephony/uicc/IccFileAdapter;->isOmhCard()Z
    ...
    .line 172
    invoke-virtual {v6}, Landroid/telephony/SmsCbMessage;->getServiceCategory()I

    move-result v1

    invoke-virtual {v6}, Landroid/telephony/SmsCbMessage;->getMessagePriority()I

    move-result v2

    .line 171
    invoke-virtual {v0, v1, v2}, Lcom/mediatek/internal/telephony/uicc/IccFileAdapter;->getBcsmsCfgFromRuim(II)I
    ...
    .line 223
    invoke-interface {v0, v1, v11, v2, v3}, Lcom/mediatek/common/sms/IInboundAutoRegSmsFwkExt;->handleAutoRegMessage(Landroid/content/Context;I[BI)Z
    ...
    .line 226
    const-string/jumbo v0, "handled auto register sms."
    ...
    invoke-virtual {v0, v10}, Lcom/android/internal/telephony/cdma/CdmaSMSDispatcher;->sendStatusReportMessage(Lcom/android/internal/telephony/cdma/SmsMessage;)V
    ...
    invoke-virtual {v0, v10}, Lcom/android/internal/telephony/cdma/CdmaServiceCategoryProgramHandler;->dispatchSmsMessage(Ljava/lang/Object;)V
