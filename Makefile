...
#-----------------------------------------------------------------------------
vendor_saved_apps := Bluetooth BluetoothMidiService HTMLViewer KeyChain PicoTts PrintSpooler UserDictionaryProvider \
                     BackupRestoreConfirmation DefaultContainerService ExternalStorageProvider FusedLocation \
		     InputDevices ProxyHandler SharedStorageBackup Shell Stk1
...
override_property += \
    ...
    ro.product.model_romer=Le X620_SiFooYee
